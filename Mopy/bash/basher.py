...
from bolt import BoltError, AbstractError, ArgumentError, StateError, \
    UncodedError, CancelError
from bolt import _, LString, Unicode, Encode, GPath, SubProgress, deprint, \
    delist
from cint import *
...
settingDefaults = {
    ...
    'bash.mods.groups'                            : [x[0] for x in
        bush.baloGroups],
    'bash.mods.ratings'                           : ['+', '1', '2', '3', '4',
        '5', '=', '~'],
    ...
    # --Installers
    'bash.installers.cols'                        : ['Package', 'Order',
        'Modified', 'Size', 'Files'],
    ...
    'bash.ini.choice'                             : 0,
    # --Wrye Flash: Mods
    'bash.mods.cols'                              : ['File', 'Load Order',
        'Rating', 'Group', 'Installer', 'Modified', 'Size', 'Author', 'CRC',
        'Activation Status'],
    ...
    # --Wrye Flash: Saves
    'bash.saves.cols'                             : ['File', 'Modified', 'Size',
        'PlayTime', 'Player', 'Cell'],
    ...
    # --Wrye Flash: Messages
    'bash.messages.cols'                          : ['Subject', 'Author',
        'Date'],
...
ID_PROFILES2 = balt.IdList(10700, 90, 'EDIT',
    'DEFAULT')  # Needed for Save_Move()
...
karmacons.data.extend({
    'karma+5': Image(GPath(bosh.dirs['images'].join('checkbox_purple_inc.png')),
        wx.BITMAP_TYPE_PNG),
    'karma+4': Image(GPath(bosh.dirs['images'].join('checkbox_blue_inc.png')),
        wx.BITMAP_TYPE_PNG),
    'karma+3': Image(GPath(bosh.dirs['images'].join('checkbox_blue_inc.png')),
        wx.BITMAP_TYPE_PNG),
    'karma+2': Image(GPath(bosh.dirs['images'].join('checkbox_green_inc.png')),
        wx.BITMAP_TYPE_PNG),
    'karma+1': Image(GPath(bosh.dirs['images'].join('checkbox_green_inc.png')),
        wx.BITMAP_TYPE_PNG),
    'karma+0': Image(GPath(bosh.dirs['images'].join('checkbox_white_off.png')),
        wx.BITMAP_TYPE_PNG),
    'karma-1': Image(GPath(bosh.dirs['images'].join('checkbox_yellow_off.png')),
        wx.BITMAP_TYPE_PNG),
    'karma-2': Image(GPath(bosh.dirs['images'].join('checkbox_yellow_off.png')),
        wx.BITMAP_TYPE_PNG),
    'karma-3': Image(GPath(bosh.dirs['images'].join('checkbox_orange_off.png')),
        wx.BITMAP_TYPE_PNG),
    'karma-4': Image(GPath(bosh.dirs['images'].join('checkbox_orange_off.png')),
        wx.BITMAP_TYPE_PNG),
    'karma-5': Image(GPath(bosh.dirs['images'].join('checkbox_red_off.png')),
        wx.BITMAP_TYPE_PNG),
}.items())
...
installercons.data.extend({
    # --Off/Archive
    'off.green'         : Image(
        GPath(bosh.dirs['images'].join('checkbox_green_off.png')),
        wx.BITMAP_TYPE_PNG),
    'off.grey'          : Image(
        GPath(bosh.dirs['images'].join('checkbox_grey_off.png')),
        wx.BITMAP_TYPE_PNG),
    'off.red'           : Image(
        GPath(bosh.dirs['images'].join('checkbox_red_off.png')),
        wx.BITMAP_TYPE_PNG),
    'off.white'         : Image(
        GPath(bosh.dirs['images'].join('checkbox_white_off.png')),
        wx.BITMAP_TYPE_PNG),
    'off.orange'        : Image(
        GPath(bosh.dirs['images'].join('checkbox_orange_off.png')),
        wx.BITMAP_TYPE_PNG),
    'off.yellow'        : Image(
        GPath(bosh.dirs['images'].join('checkbox_yellow_off.png')),
        wx.BITMAP_TYPE_PNG),
    # --Off/Archive - Wizard
    'off.green.wiz'     : Image(
        GPath(bosh.dirs['images'].join('checkbox_green_off_wiz.png')),
        wx.BITMAP_TYPE_PNG),
    # grey
    'off.red.wiz'       : Image(
        GPath(bosh.dirs['images'].join('checkbox_red_off_wiz.png')),
        wx.BITMAP_TYPE_PNG),
    'off.white.wiz'     : Image(
        GPath(bosh.dirs['images'].join('checkbox_white_off_wiz.png')),
        wx.BITMAP_TYPE_PNG),
    'off.orange.wiz'    : Image(
        GPath(bosh.dirs['images'].join('checkbox_orange_off_wiz.png')),
        wx.BITMAP_TYPE_PNG),
    'off.yellow.wiz'    : Image(
        GPath(bosh.dirs['images'].join('checkbox_yellow_off_wiz.png')),
        wx.BITMAP_TYPE_PNG),
    # --On/Archive
    'on.green'          : Image(
        GPath(bosh.dirs['images'].join('checkbox_green_inc.png')),
        wx.BITMAP_TYPE_PNG),
    'on.grey'           : Image(
        GPath(bosh.dirs['images'].join('checkbox_grey_inc.png')),
        wx.BITMAP_TYPE_PNG),
    'on.red'            : Image(
        GPath(bosh.dirs['images'].join('checkbox_red_inc.png')),
        wx.BITMAP_TYPE_PNG),
    'on.white'          : Image(
        GPath(bosh.dirs['images'].join('checkbox_white_inc.png')),
        wx.BITMAP_TYPE_PNG),
    'on.orange'         : Image(
        GPath(bosh.dirs['images'].join('checkbox_orange_inc.png')),
        wx.BITMAP_TYPE_PNG),
    'on.yellow'         : Image(
        GPath(bosh.dirs['images'].join('checkbox_yellow_inc.png')),
        wx.BITMAP_TYPE_PNG),
    # --On/Archive - Wizard
    'on.green.wiz'      : Image(
        GPath(bosh.dirs['images'].join('checkbox_green_inc_wiz.png')),
        wx.BITMAP_TYPE_PNG),
    # grey
    'on.red.wiz'        : Image(
        GPath(bosh.dirs['images'].join('checkbox_red_inc_wiz.png')),
        wx.BITMAP_TYPE_PNG),
    'on.white.wiz'      : Image(
        GPath(bosh.dirs['images'].join('checkbox_white_inc_wiz.png')),
        wx.BITMAP_TYPE_PNG),
    'on.orange.wiz'     : Image(
        GPath(bosh.dirs['images'].join('checkbox_orange_inc_wiz.png')),
        wx.BITMAP_TYPE_PNG),
    'on.yellow.wiz'     : Image(
        GPath(bosh.dirs['images'].join('checkbox_yellow_inc_wiz.png')),
        wx.BITMAP_TYPE_PNG),
    # --Off/Directory
    'off.green.dir'     : Image(
        GPath(bosh.dirs['images'].join('diamond_green_off.png')),
        wx.BITMAP_TYPE_PNG),
    'off.grey.dir'      : Image(
        GPath(bosh.dirs['images'].join('diamond_grey_off.png')),
        wx.BITMAP_TYPE_PNG),
    'off.red.dir'       : Image(
        GPath(bosh.dirs['images'].join('diamond_red_off.png')),
        wx.BITMAP_TYPE_PNG),
    'off.white.dir'     : Image(
        GPath(bosh.dirs['images'].join('diamond_white_off.png')),
        wx.BITMAP_TYPE_PNG),
    'off.orange.dir'    : Image(
        GPath(bosh.dirs['images'].join('diamond_orange_off.png')),
        wx.BITMAP_TYPE_PNG),
    'off.yellow.dir'    : Image(
        GPath(bosh.dirs['images'].join('diamond_yellow_off.png')),
        wx.BITMAP_TYPE_PNG),
    # --Off/Directory - Wizard
    'off.green.dir.wiz' : Image(
        GPath(bosh.dirs['images'].join('diamond_green_off_wiz.png')),
        wx.BITMAP_TYPE_PNG),
    # grey
    'off.red.dir.wiz'   : Image(
        GPath(bosh.dirs['images'].join('diamond_red_off_wiz.png')),
        wx.BITMAP_TYPE_PNG),
    'off.white.dir.wiz' : Image(
        GPath(bosh.dirs['images'].join('diamond_white_off_wiz.png')),
        wx.BITMAP_TYPE_PNG),
    'off.orange.dir.wiz': Image(
        GPath(bosh.dirs['images'].join('diamond_orange_off_wiz.png')),
        wx.BITMAP_TYPE_PNG),
    'off.yellow.dir.wiz': Image(
        GPath(bosh.dirs['images'].join('diamond_yellow_off_wiz.png')),
        wx.BITMAP_TYPE_PNG),
    # --On/Directory
    'on.green.dir'      : Image(
        GPath(bosh.dirs['images'].join('diamond_green_inc.png')),
        wx.BITMAP_TYPE_PNG),
    'on.grey.dir'       : Image(
        GPath(bosh.dirs['images'].join('diamond_grey_inc.png')),
        wx.BITMAP_TYPE_PNG),
    'on.red.dir'        : Image(
        GPath(bosh.dirs['images'].join('diamond_red_inc.png')),
        wx.BITMAP_TYPE_PNG),
    'on.white.dir'      : Image(
        GPath(bosh.dirs['images'].join('diamond_white_inc.png')),
        wx.BITMAP_TYPE_PNG),
    'on.orange.dir'     : Image(
        GPath(bosh.dirs['images'].join('diamond_orange_inc.png')),
        wx.BITMAP_TYPE_PNG),
    'on.yellow.dir'     : Image(
        GPath(bosh.dirs['images'].join('diamond_yellow_inc.png')),
        wx.BITMAP_TYPE_PNG),
    # --On/Directory - Wizard
    'on.green.dir.wiz'  : Image(
        GPath(bosh.dirs['images'].join('diamond_green_inc_wiz.png')),
        wx.BITMAP_TYPE_PNG),
    # grey
    'on.red.dir.wiz'    : Image(
        GPath(bosh.dirs['images'].join('diamond_red_inc_wiz.png')),
        wx.BITMAP_TYPE_PNG),
    'on.white.dir.wiz'  : Image(
        GPath(bosh.dirs['images'].join('diamond_white_off_wiz.png')),
        wx.BITMAP_TYPE_PNG),
    'on.orange.dir.wiz' : Image(
        GPath(bosh.dirs['images'].join('diamond_orange_inc_wiz.png')),
        wx.BITMAP_TYPE_PNG),
    'on.yellow.dir.wiz' : Image(
        GPath(bosh.dirs['images'].join('diamond_yellow_inc_wiz.png')),
        wx.BITMAP_TYPE_PNG),
    # --Broken
    'corrupt'           : Image(GPath(bosh.dirs['images'].join('red_x.png')),
        wx.BITMAP_TYPE_PNG),
}.items())
    ...
    def OnShow(self):
        ...
        if bosh.inisettings['AutoSizeListColumns']:
            for i in range(0, self.list.list.GetColumnCount()):
                self.list.list.SetColumnWidth(i,
                    -bosh.inisettings['AutoSizeListColumns'])
        self.SetStatusCount()
...
class SashPanel(NotebookPanel):
    ...
    def __init__(self, parent, sashPosKey=None, sashGravity=0.5, sashPos=0,
        mode=wx.VERTICAL):
        """Initialize."""
        wx.Panel.__init__(self, parent, wx.ID_ANY)
        splitter = wx.gizmos.ThinSplitterWindow(self, wx.ID_ANY,
            style=wx.BORDER_NONE | wx.SP_LIVE_UPDATE | wx.FULL_REPAINT_ON_RESIZE)
    ...
    def OnShow(self):
        ...
        if bosh.inisettings['AutoSizeListColumns']:
            for i in range(0, self.gList.gList.GetColumnCount()):
                self.gList.gList.SetColumnWidth(i,
                    -bosh.inisettings['AutoSizeListColumns'])
        self.SetStatusCount()
...
class List(wx.Panel):
    def __init__(self, parent, id=-1,
        ...
        self.list = ListCtrl(self, listId, style=ctrlStyle,
            ...
            fnDndAllow=self.dndAllow, fnDropFiles=self.OnDropFiles,
        ...
        for colDex in range(self.numCols):
            ...
            if colDex >= self.list.GetColumnCount():
                ...
                if column.GetText() == colName:
                    ...
                    self.list.SetColumnWidth(colDex,
                        self.colWidths.get(colKey, 30))
        ...
        for item in mods:
            ...
            if self.data.isSelected(fileName):
                ...
                if len(changed) > (fileName in changed):
                    ...
                    removed += changed
                    balt.showList(self, _('${count} Children deactivated:'),
                        changed, 10, _("%s") % fileName.s)
            # --Select?
            else:
                try:
                    ...
                    if len(changed) > ((fileName in changed) + (
                        GPath('FalloutNV.esm') in changed)):
                        changed.remove(fileName)
                        changed = [x.s for x in changed]
                        balt.showList(self, _('${count} Masters activated:'),
                            changed, 10, _("%s") % fileName.s)
...
class MasterList(List):
    ...
    def PopulateItem(self, itemDex, mode=0, selected=set()):
        ...
        oninc = (masterName in bosh.modInfos.ordered) or (
    ...
    def SortItems(self, col=None, reverse=-2):
        ...
        if col == 'File':
            ...
            self.items.sort(
                key=lambda a: bosh.modInfos.table.getItem(a, 'rating', ''))
        elif col == 'Group':
            self.items.sort(
                key=lambda a: bosh.modInfos.table.getItem(a, 'group', ''))
        elif col == 'Installer':
            self.items.sort(
                key=lambda a: bosh.modInfos.table.getItem(a, 'installer', ''))
        elif col == 'Modified':
    ...
    def OnLeftDown(self, event):
        ...
        if not self.edited:
            ...
            if not balt.askContinue(self, message, 'bash.masters.update',
                _('Update Masters')):
                return
            self.InitEdit()
...
class INIList(List):
    ...
    def RefreshUI(self, files='ALL', detail='SAME'):
        ...
        # --Populate
        if files == 'VALID':
            files = [GPath(self.items[x]) for x in range(len(self.items)) if
    ...
    def SortItems(self, col=None, reverse=-2):
        ...
        if col == 'File':
            ...
            self.items.sort(
                key=lambda a: bosh.iniInfos.table.getItem(a, 'installer', ''))
        else:
            raise BashError(_('Unrecognized sort key: ') + col)
        # --Ascending
        if reverse: self.items.reverse()
...
class INITweakLineCtrl(wx.ListCtrl):
    ...
    def OnSelect(self, event):
        ...
        if iniLine != -1:
            ...
            scroll = iniLine - self.iniContents.GetScrollPos(
                wx.VERTICAL) - index
    ...
    def RefreshUI(self, tweakPath):
        ...
        for i, line in enumerate(self.tweakLines):
            ...
            # --Line color
            if line[4] == -10:
                color = colors['bash.ini.invalid']
            elif line[4] == 10:
                color = colors['bash.ini.mismatched']
            elif line[4] == 20:
                color = colors['bash.ini.matched']
            else:
        ...
        for i in range(self.iniContents.GetItemCount()):
            ...
            if self.iniContents.GetItemBackgroundColour(
                i) != self.iniContents.GetBackgroundColour():
                self.iniContents.SetItemBackgroundColour(i,
                    self.iniContents.GetBackgroundColour())
    ...
    def OnSelect(self, event):
        ...
        for i, line in enumerate(self.tweakContents.tweakLines):
            if index == line[5]:
                ...
                scroll = i - self.tweakContents.GetScrollPos(
                    wx.VERTICAL) - index
...
class ModList(List):
    ...
    def __init__(self, parent):
        ...
        # --Parent init
        List.__init__(self, parent, -1, ctrlStyle=(wx.LC_REPORT), dndList=True,
    ...
    def OnDropIndexes(self, indexes, newPos):
        ...
        for thisFile in self.GetSelected():
            if GPath(thisFile) in bosh.modInfos.autoSorted:
                balt.showError(self,
                    _("Auto-ordered files cannot be manually moved."))
                return
        # Watch out for errors in range
        if newPos > indexes[0]:
            inc = 1
        elif newPos < indexes[0]:
            inc = -1
        else:
            return
    ...
    def PopulateItem(self, itemDex, mode=0, selected=set()):
        ...
        if checkMark == 1:
            mouseText += _("Active in load list.  ")
        elif checkMark == 3:
        ...
        try:
            if 'Deactivate' in bosh.modInfos[fileName].getBashTags():
                item.SetFont(
                    wx.Font(8, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_SLANT,
        ...
        elif 'Deactivate' in bosh.modInfos[
            fileName].getBashTags() and checkMark == 1:
            item.SetBackgroundColour(colors['bash.doubleTime.load'])
    ...
    def SortItems(self, col=None, reverse=-2):
        ...
        if col == 'File':
            ...
            self.items.sort(
                key=lambda a: Unicode(data[a].header.author.lower(), 'mbcs'))
        elif col == 'Rating':
            self.items.sort(
                key=lambda a: bosh.modInfos.table.getItem(a, 'rating', ''))
        elif col == 'Group':
            ...
            self.items.sort(key=lambda a: Unicode(
                bosh.modInfos.table.getItem(a, 'installer', ''), 'mbcs'))
        elif col == 'Load Order':
        ...
        if self.esmsFirst or col == 'Load Order':
            self.items.sort(
                key=lambda x: (x in bosh.modInfos) and bosh.modInfos[x].isEsp())
        # --Selected First?
        settings['bash.mods.selectedFirst'] = self.selectedFirst
        if self.selectedFirst:
            active = set(
                selected) | bosh.modInfos.imported | bosh.modInfos.merged
    ...
    def OnChar(self, event):
        ...
        elif ((event.ControlDown() and event.GetKeyCode() in (
        wx.WXK_UP, wx.WXK_DOWN)) and
            ...
            for thisFile in self.GetSelected():
                ...
                for thisFile in sorted(self.GetSelected(), key=orderKey,
                    ...
                    thisInfo, swapInfo = bosh.modInfos[thisFile], bosh.modInfos[
                        swapFile]
                    thisTime, swapTime = thisInfo.mtime, swapInfo.mtime
                    if thisTime == swapTime:
                        thisTime = bosh.modInfos.getFreeTime(thisTime, thisTime,
                            reverse=isReversed)
...
class ModDetails(wx.Window):
    ...
    def __init__(self, parent):
        ...
        # --Save/Cancel
        self.save = button(self, label=_('Save'), id=wx.ID_SAVE,
            onClick=self.DoSave, )
        self.cancel = button(self, label=_('Cancel'), id=wx.ID_CANCEL,
            onClick=self.DoCancel, )
        self.save.Disable()
        self.cancel.Disable()
        # --Bash tags
        ...
        self.gTags = (
            wx.TextCtrl(self, id, "", size=(textWidth, 100),
    ...
    def SetFile(self, fileName='SAME'):
        ...
        if fileName and bosh.modInfos.table.getItem(fileName, 'bashTags',
            None) != None:
    ...
    def DoSave(self, event):
        ...
        changeHedr = (
        (self.authorStr != Unicode(modInfo.header.author, 'mbcs')) or
        (self.descriptionStr != Unicode(modInfo.header.description, 'mbcs')))
        ...
        if changeHedr or changeMasters:
            ...
            modInfo.header.description = Encode(
                bolt.winNewLines(self.descriptionStr.strip()), 'mbcs')
    ...
    def ShowBashTagsMenu(self, event):
        ...
        # --Revert to auto
        # --Separator
        isAuto = bosh.modInfos.table.getItem(self.modInfo.name, 'bashTags',
            None) is None
        menuItem = wx.MenuItem(menu, ID_TAGS.AUTO, _('Automatic'),
            kind=wx.ITEM_CHECK)
        ...
        menu.AppendItem(menuItem)
        menuItem.Enable(
            not isAuto and self.modTags != self.modInfo.getBashTagsDesc())
...
class INIPanel(SashPanel):
    def __init__(self, parent):
        ...
        self.list = iniList
        self.comboBox = balt.comboBox(right, wx.ID_ANY,
            value=self.GetChoiceString(), choices=self.sortKeys,
    ...
    def OnSelectDropDown(self, event):
        ...
        if not path:
            # 'Browse...'
            path = balt.askOpen(self, defaultDir=self.lastDir,
                wildcard='INI files (*.ini)|*.ini', mustExist=True)
            if not path:
                self.comboBox.SetSelection(self.choice)
                return
...
class SaveList(List):
    ...
    def __init__(self, parent):
        ...
        # --Parent init
        List.__init__(self, parent, -1,
            ctrlStyle=(wx.LC_REPORT | wx.SUNKEN_BORDER | wx.LC_EDIT_LABELS))
        # --Image List
        checkboxesIL = self.checkboxes.GetImageList()
        self.list.SetImageList(checkboxesIL, wx.IMAGE_LIST_SMALL)
        # --Events
            ...
            if newFileName != path.s:
                ...
                if not newPath.exists():
                    ...
                    if GPath(oldPath.s[:-3] + 'nvse').exists():
                        GPath(oldPath.s[:-3] + 'nvse').moveTo(
                            GPath(newPath.s[:-3] + 'nvse'))
...
class SaveDetails(wx.Window):
    ...
    def __init__(self, parent):
        ...
        # --Picture
        self.picture = balt.Picture(self, textWidth, 192 * textWidth / 256,
            style=wx.BORDER_SUNKEN)  # --Native: 256x192
        # --Masters
        id = self.mastersId = wx.NewId()
        self.masters = MasterList(self, None)
        # --Save Info
        self.gInfo = wx.TextCtrl(self, -1, "", size=(textWidth, 100),
            style=wx.TE_MULTILINE)
    ...
    def SetFile(self, fileName='SAME'):
        ...
        if fileName:
            self.gInfo.SetValue(
                bosh.saveInfos.table.getItem(fileName, 'info', _('Notes: ')))
        else:
...
class InstallersList(balt.Tank):
    def __init__(self, parent, data, icons=None, mainMenu=None, itemMenu=None,
        ...
        balt.Tank.__init__(self, parent, data, icons, mainMenu, itemMenu,
            details, id, style | wx.LC_EDIT_LABELS, dndList=True, dndFiles=True,
            dndColumns=['Order'])
    ...
    @property
    def cols(self):
        return settings['bash.installers.cols']
    ...
    def OnEditLabel(self, event):
        ...
        if isinstance(self.data[selected[0]], bosh.InstallerArchive):
            InstallerType = bosh.InstallerArchive
            rePattern = re.compile(r'^([^\\/]+?)(\d*)((\.(7z|rar|zip|001))+)$',
                re.I)
            ...
            for archive in selected:
                ...
                if newName != archive:
                    ...
                    if not newPath.exists():
                        ...
                        if InstallerType is not bosh.InstallerMarker:
                            mfiles = [x for x in
                                bosh.modInfos.table.getColumn('installer') if
                                bosh.modInfos.table[x][
                                    'installer'] == oldPath.stail]
                            ifiles = [x for x in
                                bosh.iniInfos.table.getColumn('installer') if
                                bosh.iniInfos.table[x][
                                    'installer'] == oldPath.stail]
                            for i in mfiles:
                                bosh.modInfos.table[i][
                                    'installer'] = newPath.stail
                            for i in ifiles:
                                bosh.iniInfos.table[i][
                                    'installer'] = newPath.stail
                    if InstallerType is bosh.InstallerMarker:
    ...
    def OnDropFiles(self, x, y, filenames):
        ...
        filenames = [x for x in filenames if
            x.isdir() or x.cext in bosh.readExts]
        if len(omodnames) > 0:
            failed = []
            completed = []
        ...
        if action not in ['COPY', 'MOVE']:
            message = _(
                'You have dragged the following files into Wrye Flash:\n')
            for file in filenames:
                message += ' * ' + file.s + '\n'
            message += '\n'
            message += _('What would you like to do with them?')

            self.dialog = dialog = wx.Dialog(self, -1, _('Move or Copy?'),
                size=(400, 200),
                style=wx.DEFAULT_DIALOG_STYLE | wx.RESIZE_BORDER)
            icon = wx.StaticBitmap(dialog, -1,
                wx.ArtProvider_GetBitmap(wx.ART_WARNING, wx.ART_MESSAGE_BOX,
                    (32, 32)))
            ...
            sizer = vSizer(
                ...
                (hSizer(
                    spacer,
                    button(dialog, id=606, label='Move',
                        onClick=self.OnClickMove),
                    (button(dialog, id=607, label='Copy',
                        onClick=self.OnClickCopy), 0, wx.LEFT, 4),
    ...
    def OnChar(self, event):
        ...
        elif event.ControlDown() and event.GetKeyCode() == (
                ord('v') - ord('a') + 1):
            ##Ctrl+V
    ...
    def OnKeyUp(self, event):
        ...
        ##Ctrl+Shift+N - Add a marker
            ...
            event.ControlDown() and event.ShiftDown()) and event.GetKeyCode() in (
        ord('n'), ord('N')):
            ...
            if index != -1:
                self.ClearSelected()
                self.gList.SetItemState(index, wx.LIST_STATE_SELECTED,
                    wx.LIST_STATE_SELECTED)
                self.gList.EditLabel(index)
        event.Skip()
...
class InstallersPanel(SashTankPanel):
    ...
    def __init__(self, parent):
        ...
        commentsSplitter = wx.gizmos.ThinSplitterWindow(right,
            style=splitterStyle)
        subSplitter = wx.gizmos.ThinSplitterWindow(commentsSplitter,
            style=splitterStyle)
        checkListSplitter = wx.gizmos.ThinSplitterWindow(subSplitter,
            style=splitterStyle)
        # --Refreshing
        ...
        # --Layout
        subPackagesSizer = vSizer(subPackagesLabel,
            (self.gSubList, 1, wx.EXPAND, 2))
        ...
        # --Events
        self.Bind(wx.EVT_SIZE, self.OnSize)
        commentsSplitter.Bind(wx.EVT_SPLITTER_SASH_POS_CHANGED,
            self._OnCommentsSplitterSashPosChanged)
    ...
    def OnShow(self,canCancel=True):
        ...
        if not self.refreshed or (
            self.frameActivated and data.refreshInstallersNeeded()):
            ...
            try:
                ...
                if bosh.inisettings['ClearRO']:
                    ...
                    cmd = Encode(cmd, 'mbcs')
                    ins, err = subprocess.Popen(cmd, stdout=subprocess.PIPE,
        ...
        if item:
            ...
            if not installer.espms:
                ...
                balt.setCheckListItems(self.gEspmList, [
                    ['', '*'][installer.isEspmRenamed(x.s)] + x.s.replace('&',
                        '&&') for x in names],
    ...
    def RefreshInfoPage(self, index, installer):
        ...
        if pageName == 'gGeneral':
            ...
            if isinstance(installer, bosh.InstallerProject):
                ...
                if installer.isSolid:
                    if installer.blockSize:
                        sSolid = _(
                            "Solid, Block Size: %d MB") % installer.blockSize
            ...
            info += (_("Configured: %s (%s KB)\n") % (
                ...
                formatInteger(installer.unSize / 1024)), _(
                "Configured: N/A\n"),)[
                isinstance(installer, bosh.InstallerMarker)]
            info += (_("  Matched: %s\n") % formatInteger(
                nConfigured - nMissing - nMismatched), _(
                "  Matched: N/A\n"),)[
                isinstance(installer, bosh.InstallerMarker)]
            ...
            # --Infoboxes
            gPage.SetValue(
                info + dumpFiles(installer, installer.data_sizeCrc, sNone,
            ...
            gPage.SetValue(
                dumpFiles(installer, installer.missingFiles, isPath=True))
        elif pageName == 'gMismatched':
            gPage.SetValue(
                dumpFiles(installer, installer.mismatchedFiles, sNone,
                    isPath=True))
            ...
            gPage.SetValue(
                dumpFiles(installer, installer.dirty_sizeCrc, isPath=True))
        elif pageName == 'gSkipped':
            gPage.SetValue('\n'.join((
                dumpFiles(installer, installer.skipExtFiles, sNone,
                    _('== Skipped (Extension)')),
                dumpFiles(installer, installer.skipDirFiles, sNone,
                    _('== Skipped (Dir)')),
            )) or sNone)
    ...
    def PopulateItem(self, itemDex, mode=0, selected=set()):
        ...
        for colDex in range(self.numCols):
            ...
            if mode and (colDex == 0):
                ...
                self.list.SetStringItem(itemDex, colDex, value)
        # --Image
        self.list.SetItemImage(itemDex,
            self.checkboxes.Get(0, fileInfo.isApplied()))
...
class ReplacersPanel(NotebookPanel):
    ...
    def __init__(self, parent):
        ...
        self.gInvalidate = button(self, _("Update"),
            onClick=self.OnInvalidateTextures,
    ...
    def SetStatusCount(self):
        """Sets status bar count field."""
        numUsed = len(
            [info for info in self.gList.data.values() if info.isApplied()])
    ...
    def OnShow(self):
        ...
        if enableBsaEdits:
            ...
            settings['bash.replacers.autoEditBSAs'] = settings[
                'bash.replacers.autoChecked']
        else:
    ...
    def ContinueEdit(self):
        ...
        return balt.askContinue(self, message,
            'bash.replacers.editBSAs.continue', _('Textures BSA'))
...
class BSADetails(wx.Window):
    ...
    def OnInfoEdit(self, event):
        ...
        if self.BSAInfo and self.gInfo.IsModified():
            bosh.BSAInfos.table.setItem(self.BSAInfo.name, 'info',
                self.gInfo.GetValue())
...
class MessagePanel(NotebookPanel):
    ...
    def __init__(self, parent):
        ...
        gTop = self.gTop = topSash(self, defaultSize=(100, sashPos),
            onSashDrag=self.OnSashDrag)
        ...
        gMessageList.gText = wx.lib.iewin.IEHtmlWindow(gBottom, -1,
            style=wx.NO_FULL_REPAINT_ON_RESIZE)
        self.list = gMessageList
        # --Search
        gSearchBox = self.gSearchBox = wx.TextCtrl(gBottom, -1, "",
...
class BashNotebook(wx.Notebook):
    def __init__(self, parent, id):
        ...
        if bosh.inisettings['EnableReplacers'] and (
            settings['bash.replacers.show'] or bosh.dirs['mods'].join(
            "Replacers").list()):
...
class BashFrame(wx.Frame):
    ...
    def __init__(self, parent=None, pos=wx.DefaultPosition, size=(400, 500),
        ...
        self.SetSizer(sizer)
        deprint(_("Wrye Flash NV in %s Mode") % (
        ['ANSI', 'Unicode'][bolt.bUseUnicode]))
        if bolt.bUseUnicode:
            wxver = wx.version()
            deprint(wxver)
            if not 'unicode' in wxver.lower() and not '2.9' in wxver:
                balt.showWarning(bashFrame, _(
                    "Warning you appear to be using a non-unicode version of wxPython (%s) but have set Wrye Flash to unicode mode, this may cause problems, it is recommended you use a unicode version of wPython instead.") % wxver)
    ...
    def SetTitle(self, title=None):
        ...
        if not title:
            ...
            if not CBash:
                title = "Wrye Flash NV %s%s: " % (settings['bash.readme'][1],
                ('', ' (Standalone)')[settings['bash.standalone']],)
            else:
                title = "Wrye Flash NV %s%s, CBash v%u.%u.%u: " % (
    ...
    def RefreshData(self, event=None):
        ...
        if bosh.modInfos.mtimesReset:
            if bosh.modInfos.mtimesReset[0] == 'FAILED':
                balt.showWarning(self, _(
                    "It appears that the current user doesn't have permissions for some or all of the files in Fallout New Vegas\\Data.\nSpecifically had permission denied to change the time on:\n%s") %
        ...
        invalidVersions = set([x for x in bosh.modInfos.data if
            round(bosh.modInfos[x].header.version, 6) not in (
            1.32, 1.33, 1.34)])
        ...
        if self.falloutIniCorrupted != bosh.falloutIni.isCorrupted:
            ...
            if self.falloutIniCorrupted:
                message = _(
                    'Your FALLOUT.INI should begin with a section header (e.g. "[General]"), but does not. You should edit the file to correct this.')
        ...
        if settings['bosh.modInfos.fommWarn'] == 1:
            ...
            balt.showOk(self, message % ((_('off'), _('on'))[lockTimes],),
                _("Lock Times"))
...
class DocBrowser(wx.Frame):
    ...
    def __init__(self, modName=None):
        ...
        self.modNameList = wx.ListBox(self, -1,
            choices=sorted(x.s for x in self.data.keys()),
        ...
        self.openButton = button(self, _("Open Doc..."), onClick=self.DoOpen,
            tip=_("Open doc in external editor."))
        # --Html Back
    ...
    def SetMod(self, modName=None):
        ...
        if not docPath:
            ...
            myTemplate = bosh.modInfos.dir.join('Docs',
                _('My Readme Template.txt'))
            bashTemplate = bosh.modInfos.dir.join('Docs',
                _('Bash Readme Template.txt'))
...
class ModChecker(wx.Frame):
    ...
    def __init__(self):
        ...
        self.imported = None
        # --Text
        self.gTextCtrl = wx.lib.iewin.IEHtmlWindow(self, -1,
            style=wx.NO_FULL_REPAINT_ON_RESIZE)
        # --Buttons
        bitmap = wx.ArtProvider_GetBitmap(wx.ART_GO_BACK, wx.ART_HELP_BROWSER,
            (16, 16))
        gBackButton = bitmapButton(self, bitmap,
            onClick=lambda evt: self.gTextCtrl.GoBack())
        bitmap = wx.ArtProvider_GetBitmap(wx.ART_GO_FORWARD,
            wx.ART_HELP_BROWSER, (16, 16))
        gForwardButton = bitmapButton(self, bitmap,
            onClick=lambda evt: self.gTextCtrl.GoForward())
        gUpdateButton = button(self, _('Update'),
            onClick=lambda event: self.CheckMods())
        self.gShowModList = toggleButton(self, _("Mod List"),
            onClick=self.CheckMods)
        self.gShowRuleSets = toggleButton(self, _("Rule Sets"),
            onClick=self.CheckMods)
        self.gShowNotes = toggleButton(self, _("Notes"), onClick=self.CheckMods)
        self.gShowConfig = toggleButton(self, _("Configuration"),
            onClick=self.CheckMods)
        self.gShowSuggest = toggleButton(self, _("Suggestions"),
            onClick=self.CheckMods)
        if settings['bash.CBashEnabled']:
            self.gScanDirty = toggleButton(self, _("Scan for Dirty Edits"),
                onClick=self.CheckMods)
        else:
            self.gScanDirty = toggleButton(self, _("Scan for UDR's"),
                onClick=self.CheckMods)
        self.gCopyText = button(self, _("Copy Text"), onClick=self.OnCopyText)
        self.gShowModList.SetValue(
            settings.get('bash.modChecker.showModList', False))
        self.gShowNotes.SetValue(
            settings.get('bash.modChecker.showNotes', True))
        self.gShowConfig.SetValue(
            settings.get('bash.modChecker.showConfig', True))
        self.gShowSuggest.SetValue(
            settings.get('bash.modChecker.showSuggest', True))
        # --Events
        self.Bind(wx.EVT_CLOSE, self.OnCloseWindow)
...
class BashApp(wx.App):
    ...
    def Init(
        self):  # not OnInit(), we need to initialize _after_ the app has been instanced
        global appRestart
        appRestart = False
        ...
        self.InitResources()
        # --Init Data
        progress = wx.ProgressDialog(Unicode("Wrye Flash NV"),
            _("Initializing Data") + ' ' * 10,
            style=wx.PD_AUTO_HIDE | wx.PD_APP_MODAL | (
            sys.version[:3] != '2.4' and wx.PD_SMOOTH))
    ...
    def InitData(self, progress):
        ...
        if not firstBashed:
            for modInfo in bosh.modInfos.values():
                ...
                patchInfo = bosh.ModInfo(bosh.modInfos.dir,
                    GPath('Bashed Patch, 0.esp'))
                patchInfo.mtime = max([time.time()] + [info.mtime for info in
...
class ImportFaceDialog(wx.Dialog):
    ...
    def __init__(self, parent, id, title, fileInfo, faces):
        ...
        if faces and isinstance(faces.keys()[0], (IntType, LongType)):
            self.data = dict(
                ('%08X %s' % (key, face.pcName), face) for key, face in
                faces.items())
        else:
            self.data = faces
        ...
        # --List Box
        self.list = wx.ListBox(self, wx.ID_OK, choices=self.items,
            style=wx.LB_SINGLE)
...
class PatchDialog(wx.Dialog):
    ...
    def __init__(self, parent, patchInfo, doCBash=None):
        ...
        wx.Dialog.__init__(self, parent, -1,
            _("Update ") + patchInfo.name.s + ['', ' (CBash)'][doCBash],
            size=size,
            style=wx.DEFAULT_DIALOG_STYLE | wx.RESIZE_BORDER)
        ...
        groupOrder = dict([(group, index) for index, group in
            enumerate(
                (_('General'), _('Importers'), _('Tweakers'), _('Special')))])
        patchConfigs = bosh.modInfos.table.getItem(patchInfo.name,
            'bash.patch.configs', {})
        ...
        if doCBash:
            self.patchers = [copy.deepcopy(patcher) for patcher in
                PatchDialog.CBash_patchers]
        else:
            self.patchers = [copy.deepcopy(patcher) for patcher in
                PatchDialog.patchers]
        ...
        for patcher in self.patchers:
            ...
            if 'UNDEFINED' in (
            patcher.__class__.group, patcher.__class__.group):
                raise UncodedError(
                    'Name or group not defined for: ' + patcher.__class__.__name__)
        self.currentPatcher = None
        patcherNames = [patcher.getName() for patcher in self.patchers]
        # --GUI elements
        self.gExecute = button(self, id=wx.ID_OK, label=_('Build Patch'),
            onClick=self.Execute)
        self.gRevertConfig = button(self, id=wx.ID_REVERT_TO_SAVED,
            label=_('Revert To Saved'), onClick=self.RevertConfig)
        self.gSelectAll = button(self, id=wx.wx.ID_SELECTALL,
            label=_('Select All'), onClick=self.SelectAll)
        self.gDeselectAll = button(self, id=wx.wx.ID_SELECTALL,
            label=_('Deselect All'), onClick=self.DeselectAll)
        self.gExportConfig = button(self, id=wx.ID_SAVEAS,
            label=_('Export Patch Configuration'), onClick=self.ExportConfig)
        self.gImportConfig = button(self, id=wx.ID_OPEN,
            label=_('Import Patch Configuration'), onClick=self.ImportConfig)
        self.gPatchers = wx.CheckListBox(self, -1, choices=patcherNames,
            style=wx.LB_SINGLE)
        ...
        sizer = vSizer(
            ...
            (hSizer(
                ...
                (button(self, id=wx.ID_CANCEL, label=_('Cancel')), 0, wx.LEFT,
                4),
            ), 0, wx.EXPAND | wx.LEFT | wx.RIGHT | wx.BOTTOM, 4)
        )
        self.SetSizer(sizer)
        ...
        # --Patcher panels
        for patcher in self.patchers:
            gConfigPanel = patcher.GetConfigPanel(self, gConfigSizer,
                self.gTipText)
    ...
    def Execute(self, event=None):
        ...
        if not self.doCBash:
            try:
                ...
                bosh.modInfos.table.setItem(patchName, 'bash.patch.configs',
                    patchConfigs)
                # --Do it
                log = bolt.LogFile(stringBuffer())
                nullProgress = bolt.Progress()
                patchers = [patcher for patcher in self.patchers if
                    patcher.isEnabled]
                patchFile = bosh.PatchFile(self.patchInfo, patchers)
                patchFile.initData(
                    SubProgress(progress, 0, 0.1))  # try to speed this up!
                patchFile.initFactories(SubProgress(progress, 0.1,
                    0.2))  # no speeding needed/really possible (less than 1/4 second even with large LO)
                patchFile.scanLoadMods(
                    SubProgress(progress, 0.2, 0.8))  # try to speed this up!
                patchFile.buildPatch(log, SubProgress(progress, 0.8,
                    0.9))  # no speeding needed/really possible (less than 1/4 second even with large LO)
                # --Save
                ...
                try:
                    ...
                    patchName.s, patchName.s), _('Bash Patch - Save Error')):
                        try:
                            patchFile.safeSave()
                        except WindowsError, werr:
                            continue
                ...
                timerString = str(
                    timedelta(seconds=round(timer2 - timer1, 3))).rstrip('0')
                logValue = re.sub('TIMEPLACEHOLDER', timerString, logValue, 1)
                readme = bosh.modInfos.dir.join('Docs',
                    patchName.sroot + '.txt')
                ...
                balt.showWryeLog(self.parent, readme.root + '.html',
                    patchName.s, icons=bashBlue)
                # --Select?
                message = _("Activate %s?") % (patchName.s,)
                if bosh.modInfos.isSelected(patchName) or balt.askYes(
                    self.parent, message, patchName.s):
                    try:
                        oldFiles = bosh.modInfos.ordered[:]
                        bosh.modInfos.select(patchName)
                        changedFiles = bolt.listSubtract(bosh.modInfos.ordered,
                            oldFiles)
                        if len(changedFiles) > 1:
                            statusBar.SetText(_("Masters Activated: ") + `len(
                                changedFiles) - 1`)
                    except bosh.PluginsFullError:
                        balt.showError(self,
                            _("Unable to add mod %s because load list is full.")
            ...
            try:
                ...
                patchFile.initData(
                    SubProgress(progress, 0, 0.1))  # try to speed this up!
                patchFile.buildPatch(
                    SubProgress(progress, 0.1, 0.9))  # try to speed this up!
                patchFile.buildPatchLog(patchName, log,
                    SubProgress(progress, 0.95,
                        0.99))  # no speeding needed/really possible (less than 1/4 second even with large LO)
                # --Save
                ...
                try:
                    ...
                    patchName.temp.s, patchName.s, patchName.s),
    ...
    def ExportConfig(self, event=None):
        ...
        textDir.makedirs()
        # --File dialog
        textPath = balt.askSave(self.parent,
            _('Export Bashed Patch configuration to:'), textDir, patchName,
            '*Configuration.dat')
        ...
        for patcher in self.patchers:
            patcher.saveConfig(patchConfigs)
        table.setItem(bolt.Path('Saved Bashed Patch Configuration (%s)' % (
        ['Python', 'CBash'][self.doCBash])), 'bash.patch.configs', patchConfigs)
        table.save()
    ...
    def ImportConfig(self, event=None):
        ...
        textPath = balt.askOpen(self.parent,
            _('Import Bashed Patch configuration from:'), textDir, patchName,
            '*.dat', mustExist=True)
        if not textPath: return
        pklPath = textPath + '.pkl'
        ...
        patchConfigs = table.getItem(bolt.Path(
            'Saved Bashed Patch Configuration (%s)' % (
            ['Python', 'CBash'][self.doCBash])), 'bash.patch.configs', {})
        if not patchConfigs:  # try the old format:
            deprint('old format')
            patchConfigs = table.getItem(
                bolt.Path('Saved Bashed Patch Configuration'),
                'bash.patch.configs', {})
            if patchConfigs:
                configIsCBash = bosh.CBash_PatchFile.configIsCBash(patchConfigs)
                if configIsCBash != self.doCBash:
                ...
                patchConfigs = table.getItem(bolt.Path(
                    'Saved Bashed Patch Configuration (%s)' % (
                    ['CBash', 'Python'][self.doCBash])), 'bash.patch.configs',
                    {})
                if patchConfigs:
                    patchConfigs = self.UpdateConfig(patchConfigs)
        for index, patcher in enumerate(self.patchers):
            ...
            if isinstance(patcher, ListPatcher):
                ...
                for index, item in enumerate(patcher.items):
                    try:
                        ...
                        pass  # deprint(_('item %s not in saved configs') % (item))
            elif isinstance(patcher, TweakPatcher):
                for index, item in enumerate(patcher.tweaks):
                    try:
                        patcher.gList.Check(index, item.isEnabled)
                    except:
                        deprint(_('item %s not in saved configs') % (item))
        self.SetOkEnable()

    def UpdateConfig(self, patchConfigs, event=None):
        if not balt.askYes(self.parent, _(
                "Wrye Flash detects that the selected file was saved in Flash's %s mode, do you want Wrye Flash to attempt to adjust the configuration on import to work with %s mode (Good chance there will be a few mistakes)? (Otherwise this import will have no effect.)" % (
            ['CBash', 'Python'][self.doCBash],
            ['Python', 'CBash'][self.doCBash]))): return
        if not self.doCBash:
    ...
    def ConvertConfig(self, patchConfigs):
        ...
        for key in patchConfigs:
            if key in otherPatcherDict:
                newConfig[otherPatcherDict[key].__class__.__name__] = \
                patchConfigs[key]
            else:
    ...
    def RevertConfig(self, event=None):
        ...
        patchConfigs = bosh.modInfos.table.getItem(self.patchInfo.name,
            'bash.patch.configs', {})
        if bosh.CBash_PatchFile.configIsCBash(
            patchConfigs) and not self.doCBash:
            patchConfigs = self.ConvertConfig(patchConfigs)
        for index, patcher in enumerate(self.patchers):
            patcher.getConfig(patchConfigs)
            self.gPatchers.Check(index, patcher.isEnabled)
            if isinstance(patcher, ListPatcher):
                ...
                for index, item in enumerate(patcher.items):
                    try:
                        ...
                        deprint(_(
                            'Error reverting Bashed patch configuratation (error is: %s). Item %s skipped.' % (
                            err, item)))
            elif isinstance(patcher, TweakPatcher):
                for index, item in enumerate(patcher.tweaks):
                    try:
...
class AliasesPatcher(Patcher, bosh.AliasesPatcher):
    ...
    def SetAliasText(self):
        ...
        self.gAliases.SetValue('\n'.join([
            '%s >> %s' % (key.s, value.s) for key, value in
...
class ListPatcher(Patcher):
    ...
    def GetConfigPanel(self, parent, gConfigSizer, gTipText):
        ...
        if self.selectCommands:
            self.gSelectAll = button(gConfigPanel, _("Select All"),
                onClick=self.SelectAll)
            self.gDeselectAll = button(gConfigPanel, _("Deselect All"),
                onClick=self.DeselectAll)
            gSelectSizer = (vSizer(
    ...
    def SetItems(self, items):
        ...
        for index, item in enumerate(items):
            ...
            if forceItemCheck:
                ...
                self.gList.Check(index,
                    self.configChecks.setdefault(item, defaultItemCheck))
    ...
    def OnAdd(self, event):
        ...
        srcPaths = balt.askOpenMulti(self.gConfigPanel, title, srcDir, '',
            wildcard)
    ...
    def OnRemove(self, event):
        ...
        newItems = [item for index, item in enumerate(self.configItems) if
    ...
    def ShowChoiceMenu(self, event):
        ...
        itemIndex = event.m_y / itemHeight + self.gList.GetScrollPos(
            wx.VERTICAL)
...
class TweakPatcher(Patcher):
    ...
    def SetItems(self):
        ...
        for index, tweak in enumerate(self.tweaks):
            ...
            if tweak.choiceLabels and tweak.choiceLabels[
                tweak.chosen].startswith('Custom'):
                if isinstance(tweak.choiceValues[tweak.chosen][0],
                    (str, unicode)):
    ...
    def OnMouse(self, event):
        ...
        if event.RightDown():
            ...
            mouseItem = event.m_y / self.gList.GetItemHeight() + self.gList.GetScrollPos(
                wx.VERTICAL)
            self.mouseState = False
            if mouseItem != self.mouseItem:
                self.mouseItem = mouseItem
    ...
    def ShowChoiceMenu(self, event):
        """Displays a popup choice menu if applicable."""
        # --Tweak Index
        tweakIndex = event.m_y / self.gList.GetItemHeight() + self.gList.GetScrollPos(
            wx.VERTICAL)
        ...
        for index, label in enumerate(choiceLabels):
            if label == '----':
                ...
                if isinstance(tweaks[tweakIndex].choiceValues[index][0],
                    (str, unicode)):
                    menulabel = label + ' %s' % \
                                        tweaks[tweakIndex].choiceValues[index][
                                            0]
                else:
                    menulabel = label + ' %4.2f ' % \
                                        tweaks[tweakIndex].choiceValues[index][
                                            0]
                menuItem = wx.MenuItem(menu, index, menulabel,
                    kind=wx.ITEM_CHECK)
                menu.AppendItem(menuItem)
    ...
    def OnTweakCustomChoice(self, event):
            ...
            if subtweaktype == float:
                label = _(
                    'Enter the desired custom tweak value.\nDue to an inability to get decimal numbers from the wxPython prompt please enter an extra zero after your choice if it is not meant to be a decimal.\nIf you are trying to enter a decimal multiply it by 10, for example for 0.3 enter 3 instead.\n%s') % (
                        tweak.key[i])
                new = balt.askNumber(self.gConfigPanel, label,
                    prompt=_('Value'),
                    title=_('%s ~ Custom Tweak Value') % (tweak.label),
                    value=self.tweaks[tweakIndex].choiceValues[index][i],
                    min=-10000, max=10000)
                ...
                new = balt.askText(self.gConfigPanel, label,
                    title=_('%s ~ Custom Tweak Text') % (tweak.label),
                    default=self.tweaks[tweakIndex].choiceValues[index][i])
                if new == None:  # user hit cancel
                    return
                value.append(new)
        ...
        if isinstance(tweak.choiceValues[index][0], (str, unicode)):
            menulabel = tweak.getListLabel() + ' %s' % \
                                               tweak.choiceValues[index][0]
        else:
            menulabel = tweak.getListLabel() + ' %4.2f ' % \
                                               tweak.choiceValues[index][0]
...
otherPatcherDict = {AliasesPatcher().__class__.__name__: CBash_AliasesPatcher(),
    ...
    ImportScriptContents().__class__.__name__          : ImportScriptContents(),
    # No CBash equiv
...
class Files_SortBy(Link):
    ...
    def AppendToMenu(self, menu, window, data):
        ...
        menuItem = wx.MenuItem(menu, self.id, self.prefix + self.sortName,
            _('Sort by %s') % (self.sortName), kind=wx.ITEM_RADIO)
        menu.AppendItem(menuItem)
...
class Files_Unhide(Link):
    ...
    def Execute(self, event):
        ...
        if self.type == 'mod':
            ...
            srcPaths = balt.askOpenMulti(window, _('Unhide files:'), srcDir,
                '.Folder Selection.', wildcard)
        else:
            wildcard = '*.*'
...
class File_Duplicate(Link):
    ...
    def Execute(self, event):
        ...
        for item in data:
            ...
            # --Mod with resources?
            # --Warn on rename if file has bsa and/or dialog
            if fileInfo.isMod() and tuple(fileInfo.hasResources()) != (
            False, False):
                ...
                if hasBsa and hasVoices:
                    ...
                    message = _(
                        "This mod has an associated voice directory (Sound\\Voice\\%s), which will not be attached to the duplicate mod.") % (
                              modName.s,)
                if not balt.askWarning(self.window, message,
                        _("Duplicate ") + fileName.s):
                    continue
            # --Continue copy
...
class File_Hide(Link):
    ...
    def Execute(self, event):
        if not bosh.inisettings['SkipHideConfirmation']:
            message = _(
                r'Hide these files? Note that hidden files are simply moved to the Bash\Hidden subdirectory.')
        ...
        for fileName in self.data:
            ...
            author = getattr(fileInfos[fileName].header, 'author',
                'NOAUTHOR')  # --Hack for save files.
            ...
            if not self.window.data.moveIsSafe(fileName, destDir):
                message = (_(
                    'A file named %s already exists in the hidden files directory. Overwrite it?')
                           % (fileName.s,))
                if not balt.askYes(self.window, message,
                    _('Hide Files')): continue
            # --Do it
...
class File_ListMasters(Link):
    ...
    def Execute(self, event):
        ...
        if (wx.TheClipboard.Open()):
            wx.TheClipboard.SetData(wx.TextDataObject(text))
            wx.TheClipboard.Close()
        balt.showLog(self.window, text, fileName.s, asDialog=False,
...
class File_Redate(Link):
    ...
    def Execute(self, event):
        ...
        newTimeStr = balt.askText(self.window,
        ...
        try:
            ...
            balt.showError(self,
                _('Bash cannot handle dates greater than January 19, 2038.)'))
            return
        # --Do it
...
class File_Sort(Link):
    ...
    def Execute(self, event):
        ...
        if not balt.askContinue(self.window, message, 'bash.sortMods.continue',
            _('Sort Mods')):
            return
        ...
        fileNames = [mod for mod in self.data if mod not in modInfos.autoSorted]
        if not fileNames: return
        dotTimes = [modInfos[fileName].mtime for fileName in fileNames if
            fileName.s[0] in '.=+']
        if dotTimes:
    ...
    def Execute(self, event):
        ...
        for item in data:
            ...
            fileVersion = bolt.getMatch(
                re.search(r'[ _]+v?([\.0-9]+)$', fileRoot.s), 1)
            snapVersion = bolt.getMatch(re.search(r'-[0-9\.]+$', destRoot.s))
            fileHedr = fileInfo.header
            if fileInfo.isMod() and (
                fileVersion or snapVersion) and bosh.reVersion.search(
                ...
                newDescription = bosh.reVersion.sub(r'\1 ' + newVersion,
...
class File_RevertToSnapshot(Link):
    ...
    def Execute(self, event):
        ...
        # --File dialog
        srcDir.makedirs()
        snapPath = balt.askOpen(self.window,
            _('Revert %s to snapshot:') % (fileName.s,),
...
class List_Column(Link):
    ...
    def Execute(self, event):
        if self.colName in settings[self.columnsKey]:
            ...
            settings[self.columnsKey] = [x for x in
                settingDefaults[self.columnsKey] if
                x in settings[self.columnsKey] or x == self.colName]
...
class List_Columns(Link):
    ...
    def AppendToMenu(self, menu, window, data):
        ...
        for col in settingDefaults[self.columnsKey]:
            ...
            List_Column(self.columnsKey, col, enable).AppendToMenu(subMenu,
                window, data)
...
class Installers_AddMarker(Link):
    ...
    def AppendToMenu(self, menu, window, data):
        Link.AppendToMenu(self, menu, window, data)
        menuItem = wx.MenuItem(menu, self.id, _('Add Marker...'), _(
    ...
    def Execute(self, event):
        ...
        if index != -1:
            ...
            self.gTank.gList.SetItemState(index, wx.LIST_STATE_SELECTED,
                wx.LIST_STATE_SELECTED)
...
class Installers_AnnealAll(Link):
    ...
    def AppendToMenu(self, menu, window, data):
        Link.AppendToMenu(self, menu, window, data)
        menuItem = wx.MenuItem(menu, self.id, _('Anneal All'), _(
...
class Installers_UninstallAllPackages(Link):
    ...
    def AppendToMenu(self, menu, window, data):
        Link.AppendToMenu(self, menu, window, data)
        menuItem = wx.MenuItem(menu, self.id, _('Uninstall All Packages'),
            _('This will uninstall all packages.'))
        menu.AppendItem(menuItem)
...
class Installers_UninstallAllUnknownFiles(Link):
    ...
    def __init__(self):
        Link.__init__(self)
        self._helpMessage = _(
            'This will remove all mod files that are not linked to an active installer out of the Data folder.')

    def AppendToMenu(self, menu, window, data):
        Link.AppendToMenu(self, menu, window, data)
        menuItem = wx.MenuItem(menu, self.id, _('Clean Data'),
            self._helpMessage)
        menu.AppendItem(menuItem)
    ...
    def Execute(self, event):
        """Handle selection."""
        fullMessage = _(
            "Clean Data directory?") + "  " + self._helpMessage + "  " + _(
            'This includes files that were installed manually or by another program.  Files will be moved to the "%s" directory instead of being deleted so you can retrieve them later if necessary.') % r'Fallout New Vegas Mods\Bash Installers\Bash\Data Folder Contents <date>'
    ...
    def Execute(self, event):
        ...
        if settings[self.key]:
            bsaPath = bosh.modInfos.dir.join(
                bosh.inisettings['FalloutTexturesBSAName'])
            bsaFile = bosh.BsaFile(bsaPath)
            bsaFile.scan()
            resetCount = bsaFile.reset()
            # balt.showOk(self,_("BSA Hashes reset: %d") % (resetCount,))
...
class Installers_AvoidOnStart(BoolLink):
    ...
    def __init__(self): BoolLink.__init__(self,
        ...
        _(
            "Toggles Wrye Flash to avoid the Installers tab on startup, avoiding unnecessary data scanning.")
    )
...
class Installers_ExportDllInfo(Link):
    ...
    def AppendToMenu(self, menu, window, data):
        ...
        menuItem = wx.MenuItem(menu, self.id,
            _("Export list of allowed/disallowed NVSE plugin dlls"))
        menu.AppendItem(menuItem)
    ...
    def Execute(self, event):
        ...
        textDir.makedirs()
        # --File dialog
        textPath = balt.askSave(self.wdw,
            _('Export list of allowed/disallowed NVSE plugin dlls to:'),
            textDir, _("NVSE dll permissions.txt"), '*.txt')
        if not textPath: return
        try:
            out = textPath.open("w")
            out.write(
            ...
            if settings['bash.installers.goodDlls']:
                for dll in settings['bash.installers.goodDlls']:
                    ...
                    for index, version in enumerate(
                        settings['bash.installers.goodDlls'][dll]):
            ...
            if settings['bash.installers.badDlls']:
                for dll in settings['bash.installers.badDlls']:
                    out.write('dll:' + dll + ':\n')
                    for index, version in enumerate(
                        settings['bash.installers.badDlls'][dll]):
                        out.write('version %02d: %s\n' % (index, version))
            else:
                out.write("None")
        finally:
...
class Installers_ImportDllInfo(Link):
    ...
    def AppendToMenu(self, menu, window, data):
        ...
        Link.AppendToMenu(self, menu, window, data)
        menuItem = wx.MenuItem(menu, self.id,
            _("Import list of allowed/disallowed NVSE plugin dlls"))
        menu.AppendItem(menuItem)
    ...
    def Execute(self, event):
        ...
        textDir.makedirs()
        # --File dialog
        textPath = balt.askOpen(self.wdw,
            _('Import list of allowed/disallowed NVSE plugin dlls from:'),
        ...
        if not balt.askYes(self.wdw, message, _('Merge permissions?')):
            replace = True
        else:
            replace = False
        try:
            ...
            for line in inp:
                ...
                if line.startswith('badDlls'):
                    ...
                    current[dll].append(
                        [ver[0].strip("'"), int(ver[1]), long(ver[2])])
        finally:
            inp.close
        if not replace:
            ...
            settings['bash.installers.goodDlls'], settings[
                'bash.installers.badDlls'] = Dlls['goodDlls'], Dlls['badDlls']
...
class InstallerLink(Link):
    ...
    def filterInstallables(self):
        return [archive for archive in self.selected if
            archive in self.data and self.data[archive].type in (1, 2) and (
            isinstance(self.data[archive], bosh.InstallerProject) or isinstance(
                self.data[archive], bosh.InstallerArchive))]
    ...
    def isSingleMarker(self):
        ...
        if len(self.selected) != 1:
            ...
            return isinstance(self.data[self.selected[0]], bosh.InstallerMarker)
    ...
    def isSelectedArchives(self):
        ...
        for selected in self.selected:
            if not isinstance(self.data[selected],
    ...
    def Execute(self, event):
        with balt.BusyCursor():
            ...
            if not isinstance(pos, tuple) or len(pos) != 2:
                deprint(
                    'Saved Wizard position (%s) was not a tuple (%s), reverting to default position.' % (
                    pos, type(pos)))
                pos = wx.DefaultPosition
            if not isinstance(saved, tuple) or len(saved) != 2:
                deprint(
                    'Saved Wizard size (%s) was not a tuple (%s), reverting to default size.' % (
                    saved, type(saved)))
                pageSize = tuple(default)
            else:
                pageSize = (
                max(saved[0], default[0]), max(saved[1], default[1]))
        ...
        if not isinstance(ret.Pos, wx.Point):
            deprint(
                'Returned Wizard position (%s) was not a wx.Point (%s), reverting to default position.' % (
                ret.Pos, type(ret.Pos)))
            ret.Pos = wx.DefaultPosition
        if not isinstance(ret.PageSize, wx.Size):
            deprint(
                'Returned Wizard size (%s) was not a wx.Size (%s), reverting to default size.' % (
        ...
        for iniFile in ret.IniEdits:
            outFile = bosh.dirs['mods'].join('INI Tweaks',
                '%s - Wizard Tweak [%s].ini' % (
            ...
            if iniFile in installer.data_sizeCrc or iniFile.cs == 'fallout.ini':
                ...
                if iniFile.cs == 'falout.ini':
                    ...
                    if not balt.askContinue(self.gTank, message,
...
class Installer_OverrideSkips(InstallerLink):
    ...
    def AppendToMenu(self, menu, window, data):
        Link.AppendToMenu(self, menu, window, data)
        menuItem = wx.MenuItem(menu, self.id, _('Override Skips'),
            kind=wx.ITEM_CHECK)
        menu.AppendItem(menuItem)
        if self.isSingleInstallable():
            installer = self.data[self.selected[0]]
...
class Installer_SkipRefresh(InstallerLink):
    ...
    def AppendToMenu(self, menu, window, data):
        Link.AppendToMenu(self, menu, window, data)
        menuItem = wx.MenuItem(menu, self.id, _("Don't Refresh"),
            kind=wx.ITEM_CHECK)
        menu.AppendItem(menuItem)
        if self.isSingleProject():
            installer = self.data[self.selected[0]]
    ...
    def Execute(self, event):
        ...
        if not installer.skipRefresh:
            ...
            if (installer.size, installer.modified) != (
            file.size, file.getmtime(True)):
                installer.refreshDataSizeCrc()
...
class Installer_Install(InstallerLink):
    ...
    def Execute(self, event):
        ...
        try:
            ...
            self.data.install(self.filterInstallables(), progress, last,
                override)
        finally:
            progress.Destroy()
            self.data.refresh(what='N')
...
class Installer_ListPackages(InstallerLink):
    ...
    def AppendToMenu(self, menu, window, data):
        ...
        menuItem = wx.MenuItem(menu, self.id, _("List Packages..."), _(
    ...
    def Execute(self, event):
        ...
        if (wx.TheClipboard.Open()):
            wx.TheClipboard.SetData(wx.TextDataObject(text))
            wx.TheClipboard.Close()
        balt.showLog(self.gTank, text, _("BAIN Packages"), asDialog=False,
            fixedFont=False, icons=bashBlue)
...
class Installer_ListStructure(InstallerLink):  # Provided by Waruddar
    ...
    def AppendToMenu(self, menu, window, data):
        ...
        menuItem = wx.MenuItem(menu, self.id, self.title)
        menu.AppendItem(menuItem)
        if not self.isSingle() or isinstance(self.data[self.selected[0]],
    ...
    def Execute(self, event):
        ...
        if (wx.TheClipboard.Open()):
            wx.TheClipboard.SetData(wx.TextDataObject(text))
            wx.TheClipboard.Close()
        balt.showLog(self.gTank, text, _("Package Structure"), asDialog=False,
            fixedFont=False, icons=bashBlue)
...
class Installer_Open(balt.Tank_Open):
    ...
    def AppendToMenu(self, menu, window, data):
        ...
        self.selected = [x for x in self.selected if
            not isinstance(self.data.data[x], bosh.InstallerMarker)]
...
class Installer_OpenNewVegasNexus(InstallerLink):
    ...
    def Execute(self, event):
        """Handle selection."""
        message = _(
            "Attempt to open this as a mod at New Vegas Nexus? This assumes that the trailing digits in the package's name are actually the id number of the mod at NewVegasNexus. If this assumption is wrong, you'll just get a random mod page (or error notice) at New Vegas Nexus.")
        if balt.askContinue(self.gTank, message,
            'bash.installers.openNewVegasNexus', _('Open at New Vegas Nexus')):
...
class Installer_OpenSearch(InstallerLink):
    ...
    def Execute(self, event):
        ...
        if balt.askContinue(self.gTank, message, 'bash.installers.opensearch',
            _('Open a search')):
            os.startfile('http://www.google.com/search?hl=en&q=' + '+'.join(
                re.split(r'\W+|_+',
                    bosh.reNewVegasNexus.search(self.selected[0].s).group(1))))
...
class Installer_SkipVoices(InstallerLink):
    ...
    def AppendToMenu(self, menu, window, data):
        Link.AppendToMenu(self, menu, window, data)
        menuItem = wx.MenuItem(menu, self.id, _('Skip Voices'),
            kind=wx.ITEM_CHECK)
        menu.AppendItem(menuItem)
        if self.isSingleInstallable():
            installer = self.data[self.selected[0]]
            ...
            if mismatched:
                ...
                for package in sorted(data.data, key=getArchiveOrder):
                    ...
                    for x, y in installer.refreshDataSizeCrc().iteritems():
                        if x in mismatched and installer.data_sizeCrc[x] != \
                            src_sizeCrc[x]:
                            curConflicts.add(y)
                ...
                if numFiles:
                    ...
                    if isinstance(srcInstaller, bosh.InstallerProject):
                        for src in srcConflicts:
                            srcFull = bosh.dirs['installers'].join(srcArchive,
                                src)
                            destFull = bosh.dirs['installers'].join(destDir,
                                GPath(srcArchive.s), src)
                            if srcFull.exists():
                                progress(curFile,
                                    _("%s\nCopying files...\n%s") % (
                                    srcArchive.s, src))
                        ...
                        srcInstaller.unpackToTemp(srcArchive, srcConflicts,
                            SubProgress(progress, 0, len(srcConflicts),
                                numFiles))
                        srcInstaller.tempDir.moveTo(
                            bosh.dirs['installers'].join(destDir,
                                GPath(srcArchive.s)))
                    curFile = len(srcConflicts)
                    for order, installer, package, curConflicts in packConflicts:
                        if isinstance(installer, bosh.InstallerProject):
                            for src in curConflicts:
                                srcFull = bosh.dirs['installers'].join(package,
                                    src)
                                destFull = bosh.dirs['installers'].join(destDir,
                                    GPath("%03d - %s" % (order, package.s)),
                                    src)
                                if srcFull.exists():
                                    progress(curFile,
                                        _("%s\nCopying files...\n%s") % (
...
class Installer_Espm_Rename(InstallerLink):
    ...
    def Execute(self, event):
        ...
        newName = balt.askText(self.window,
            _("Enter new name (without the extension):"),
...
class Installer_Espm_List(InstallerLink):
    ...
    def Execute(self, event):
        ...
        if (wx.TheClipboard.Open()):
            ...
            wx.TheClipboard.Close()
        balt.showLog(self.window, subs, _("Esp/m List"), asDialog=False,
            fixedFont=False, icons=bashBlue)
...
class Installer_Subs_ListSubPackages(InstallerLink):
    ...
    def Execute(self, event):
        ...
        if (wx.TheClipboard.Open()):
            wx.TheClipboard.SetData(wx.TextDataObject(subs))
            wx.TheClipboard.Close()
        balt.showLog(self.window, subs, _("Sub-Package List"), asDialog=False,
            fixedFont=False, icons=bashBlue)
    ...
    def Execute(self, event):
        ...
        with balt.Progress(_("Unpacking to Project..."),
            ...
            if self.isSingleArchive():
                ...
                pProject = bosh.dirs['installers'].join(project)
                iProject.refreshed = False
                iProject.refreshBasic(pProject,
                    SubProgress(progress, 0.8, 0.99), True)
                if iProject.order == -1:
                ...
                for archive in self.selected:
                    ...
                    if project in self.data:
                        if not balt.askYes(self.gTank, _(
                            "%s already exists. Overwrite it?") % project.s,
                            self.title, False):
                            continue
                    installer.unpackToProject(archive, project,
                        SubProgress(progress, 0, 0.8))
...
class InstallerProject_FomodConfigDialog(wx.Frame):
    ...
    def __init__(self, parent, data, project):
        ...
        self.gDescription = wx.TextCtrl(self, -1, Unicode(config.description),
            style=wx.TE_MULTILINE)
        # --Max Lenght
    ...
    def DoSave(self, event):
        ...
        config.description = Unicode(self.gDescription.GetValue().strip(),
            'mbcs')
        # --Version
...
class InstallerProject_FomodConfig(InstallerLink):
    ...
    def Execute(self, event):
        ...
        dialog = InstallerProject_FomodConfigDialog(self.gTank, self.data,
            project)
        dialog.Show()
...
class InstallerProject_Pack(InstallerLink):
    ...
    def Execute(self, event):
        ...
        if not archive.s:
            balt.ShowWarning(self.gTank,
                _("%s is not a valid archive name.") % result)
            return
        ...
        if archive.cext not in bosh.writeExts:
            balt.showWarning(self.gTank,
                _("The %s extension is unsupported. Using %s instead.") % (
                archive.cext, bosh.defaultExt))
            archive = GPath(archive.sroot + bosh.defaultExt).tail
        if archive in self.data:
            if not balt.askYes(self.gTank,
                    _("%s already exists. Overwrite it?") % archive.s,
                self.title, False): return
        ...
        if archive.cext in bosh.noSolidExts:
            ...
            if not '-ms=' in bosh.inisettings['7zExtraCompressionArguments']:
                isSolid = balt.askYes(self.gTank,
                    _("Use solid compression for %s?") % archive.s, self.title,
                    False)
                if isSolid:
                    blockSize = balt.askNumber(self.gTank, _(
...
class InstallerProject_ReleasePack(InstallerLink):
    ...
    def Execute(self, event):
        ...
        with balt.Progress(_("Packing to Archive..."),
            ...
            # --Pack
            installer.packToArchive(project, archive, isSolid, blockSize,
                SubProgress(progress, 0, 0.8), release=True)
            # --Add the new archive to Bash
            if archive not in self.data:
                self.data[archive] = bosh.InstallerArchive(archive)
            # --Refresh UI
...
class InstallerConverter_Apply(InstallerLink):
    ...
    def __init__(self, converter, numAsterisks):
        ...
        self.dispName = ''.join(
            (self.converter.fullPath.sbody, '*' * numAsterisks))
    ...
    def Execute(self, event):
        ...
        message = _("Using:\n* ")
        message += '\n* '.join(sorted(
            "(%08X) - %s" % (x, self.data.crc_installer[x].archive) for x in
            self.converter.srcCRCs)) + '\n'
        # --Confirm operation
        result = balt.askText(self.gTank, message, self.title,
            result + bosh.defaultExt)
        result = (result or '').strip()
        if not result: return
        # --Error checking
        ...
        if destArchive in self.data:
            if not balt.askYes(self.gTank,
                    _("%s already exists. Overwrite it?") % destArchive.s,
                self.title, False): return
        with balt.Progress(_("Converting to Archive..."),
                '\n' + ' ' * 60) as progress:
            # --Perform the conversion
            self.converter.apply(destArchive, self.data.crc_installer,
...
class InstallerConverter_ConvertMenu(balt.MenuLink):
    ...
    def AppendToMenu(self, menu, window, data):
        ...
        selectedCRCs = set(
            window.data[archive].crc for archive in window.GetSelected())
        ...
        if selectedCRCs <= srcCRCs:
            ...
            linkSet = set(
                [converter for installerCRC in selectedCRCs for converter in
                    window.data.srcCRC_converters[installerCRC] if
        ...
        if not linkSet:
            ...
            for converter in sorted(linkSet,
                key=lambda x: x.fullPath.stail.lower()):
...
class InstallerConverter_Create(InstallerLink):
    ...
    def Execute(self, event):
        ...
        destArchive = balt.askOpen(self.gTank,
            _('Select the BAIN\'ed Archive:'), self.data.dir, '', readTypes,
            mustExist=True)
        ...
        if not destArchive.s or destArchive.cext not in bosh.readExts:
            balt.showWarning(self.gTank,
                _("%s is not a valid archive name.") % destArchive.s)
            return
        if destArchive not in self.data:
            balt.showWarning(self.gTank, _(
                "%s must be in the Bash Installers directory.") % destArchive.s)
            return
        if BCFArchive.csbody[-4:] != _('-bcf'):
            BCFArchive = GPath(
                BCFArchive.sbody + _('-BCF') + bosh.defaultExt).tail
        # --List source archives and target archive
        message = _("Convert:")
        message += '\n* ' + '\n* '.join(sorted(
            "(%08X) - %s" % (self.data[x].crc, x.s) for x in self.selected))
        message += _('\n\nTo:\n* (%08X) - %s') % (
        self.data[destArchive].crc, destArchive.s) + '\n'
        # --Confirm operation
        ...
        if destInstaller.isSolid:
            blockSize = balt.askNumber(self.gTank, 'mb', _(
                "Use what maximum size for each solid block?\nEnter '0' to use 7z's default size."),
        ...
        try:
            ...
            converter = bosh.InstallerConverter(self.selected, self.data,
            ...
            log(_('. Size: %s KB') % formatInteger(
                converter.fullPath.size / 1024))
            log(_('. Remapped: %s file') % formatInteger(
                len(converter.convertedFiles)) + ('', _('s'))[
                    len(converter.convertedFiles) > 1])
            log.setHeader(_('. Requires: %s file') % formatInteger(
                len(converter.srcCRCs)) + ('', _('s'))[
                              len(converter.srcCRCs) > 1])
            log('  * ' + '\n  * '.join(sorted(
                "(%08X) - %s" % (x, self.data.crc_installer[x].archive) for x in
                converter.srcCRCs if x in self.data.crc_installer)))
            ...
            if converter.isSolid:
                if converter.blockSize:
                    log(_('    *  Solid Block Size = %d') % (
                    converter.blockSize))
                else:
                    log(_('    *  Solid Block Size = 7z default'))
            log(_('  *  Has Comments  = %s') % bool(converter.comments))
            log(_('  *  Has Extra Directories = %s') % bool(
                converter.hasExtraData))
            log(_('  *  Has Esps Unselected   = %s') % bool(converter.espmNots))
            log(_('  *  Has Packages Selected = %s') % bool(
                converter.subActives))
            log.setHeader(_('. Contains: %s file') % formatInteger(
                len(converter.missingFiles)) + ('', _('s'))[
                              len(converter.missingFiles) > 1])
            log('  * ' + '\n  * '.join(
                sorted("%s" % (x) for x in converter.missingFiles)))
        finally:
            progress.Destroy()
            if log:
                balt.showLog(self.gTank, log.out.getvalue(),
                    _("BCF Information"))
...
class Mods_LoadList:
    ...
    def AppendToMenu(self, menu, window, data):
        ...
        wx.EVT_MENU_RANGE(bashFrame, ID_LOADERS.BASE, ID_LOADERS.MAX,
            self.DoList)
    ...
    def DoSave(self, event):
        ...
        if len(self.data) >= (ID_LOADERS.MAX - ID_LOADERS.BASE + 1):
            ...
            return
        # --Dialog
        newItem = (balt.askText(self.window, _('Save current load list as:'),
            'Wrye Flash NV') or '').strip()
...
class INI_ListErrors(Link):
    ...
    def AppendToMenu(self, menu, window, data):
        ...
        menuItem = wx.MenuItem(menu, self.id, _('List Errors...'),
            _('Lists any errors in the tweak file causing it to be invalid.'))
        menu.AppendItem(menuItem)
    ...
    def Execute(self, event):
        ...
        if (wx.TheClipboard.Open()):
            ...
            wx.TheClipboard.SetData(wx.TextDataObject(text))
            wx.TheClipboard.Close()
        balt.showLog(self.window, text, _('INI Tweak Errors'), asDialog=False,
            fixedFont=False, icons=bashBlue)
...
class INI_Apply(Link):
    ...
    def Execute(self, event):
        ...
        if needsRefresh:
            ...
            self.window.GetParent().GetParent().GetParent().tweakContents.RefreshUI(
                self.data[0])
...
class INI_CreateNew(Link):
    ...
    def AppendToMenu(self, menu, window, data):
        ...
        ini = self.window.GetParent().GetParent().GetParent().comboBox.GetValue()
        tweak = data[0]
        menuItem = wx.MenuItem(menu, self.id, _('Copy to new Tweak...'), _(
    ...
    def Execute(self, event):
        ...
        path = balt.askSave(self.window, _('Copy to new Tweak...'),
            bosh.dirs['mods'].join('INI Tweaks'), fileName,
            _('INI Tweak File (*.ini)|*.ini'))
        if not path: return
...
class Mods_EsmsFirst(Link):
    ...
    def AppendToMenu(self, menu, window, data):
        ...
        menuItem = wx.MenuItem(menu, self.id, self.prefix + _('Type'),
            _('Sort masters by type'), kind=wx.ITEM_CHECK)
        menu.AppendItem(menuItem)
...
class Mods_Deprint(Link):
    ...
    def AppendToMenu(self, menu, window, data):
        Link.AppendToMenu(self, menu, window, data)
        menuItem = wx.MenuItem(menu, self.id, _('Debug Mode'),
            kind=wx.ITEM_CHECK)
        menu.AppendItem(menuItem)
...
class Mods_FullBalo(BoolLink):
    ...
    def Execute(self, event):
        if not settings[self.key]:
            ...
            if balt.askContinue(self.window, message, 'bash.balo.full.continue',
                _('Balo Groups')):
...
class Mods_DumpTranslator(Link):
    ...
    def Execute(self, event):
        ...
        if not balt.askContinue(self.window, message,
            'bash.dumpTranslator.continue', _('Dump Translator')):
            return
        import locale
        ...
        for pyPath in (GPath('bash').join(x + '.py') for x in
        ('bolt', 'balt', 'bush', 'bosh', 'bash', 'basher', 'bashmon', 'belt')):
            pyText = pyPath.open()
        ...
        balt.showOk(self.window,
            (_('%d translation keys written to Mopy\\Data\\%s.') % (
            keyCount, outPath.stail)),
...
class Mods_ListMods(Link):
    ...
    def Execute(self, event):
        ...
        if (wx.TheClipboard.Open()):
            wx.TheClipboard.SetData(wx.TextDataObject(text))
            wx.TheClipboard.Close()
        balt.showLog(self.window, text, _("Active Mod Files"), asDialog=False,
            fixedFont=False, icons=bashBlue)
...
class Mods_ListBashTags(Link):
    ...
    def Execute(self, event):
        ...
        if (wx.TheClipboard.Open()):
            wx.TheClipboard.SetData(wx.TextDataObject(text))
            wx.TheClipboard.Close()
        balt.showLog(self.window, text, _("Bash Tags"), asDialog=False,
            fixedFont=False, icons=bashBlue)
...
class Mods_LockTimes(Link):
    ...
    def Execute(self, event):
        ...
        settings[
            'bosh.modInfos.resetMTimes'] = bosh.modInfos.lockTimes = lockTimes
        bosh.modInfos.refresh(doInfos=False)
        modList.RefreshUI()
...
class Mods_FalloutVersion(Link):
    ...
    def AppendToMenu(self, menu, window, data):
        ...
        menu.AppendItem(menuItem)
        menuItem.Enable(
            bosh.modInfos.voCurrent != None and self.key in bosh.modInfos.voAvailable)
    ...
    def Execute(self, event):
        ...
        modList.RefreshUI()
        if self.setProfile:
            bosh.saveInfos.profiles.setItem(bosh.saveInfos.localSave,
                'vFalloutNV', self.key)
        bashFrame.SetTitle()
...
class User_BackupSettings(Link):
    ...
    def AppendToMenu(self, menu, window, data):
        Link.AppendToMenu(self, menu, window, data)
        menuItem = wx.MenuItem(menu, self.id, _('Backup Settings...'),
            help="Backup all of Wrye Flash's settings/data to an archive file.",
            kind=wx.ITEM_CHECK)
        menu.AppendItem(menuItem)
    ...
    def Execute(self, event):
        ...
        try:
            if PromptConfirm():
                dialog = wx.Dialog(bashFrame, -1, _('Backup Images?'),
                    size=(400, 200),
                    style=wx.DEFAULT_DIALOG_STYLE | wx.RESIZE_BORDER)
                icon = wx.StaticBitmap(dialog, -1,
                    wx.ArtProvider_GetBitmap(wx.ART_WARNING, wx.ART_MESSAGE_BOX,
                ...
                sizer = vSizer(
                    (hSizer(
                        (icon, 0, wx.ALL, 6),
                        (staticText(dialog,
                            _("Do you want to backup any images?"),
                            style=wx.ST_NO_AUTORESIZE), 1, wx.EXPAND | wx.LEFT,
                        6),
                    ), 1, wx.EXPAND | wx.ALL, 6),
                    (hSizer(
                        spacer,
                        button(dialog, id=606, label='Backup All Images',
                            onClick=OnClickAll),
                        (button(dialog, id=607, label='Backup Changed Images',
                            onClick=OnClickNone), 0, wx.LEFT, 4),
                        (button(dialog, id=wx.ID_CANCEL, label='None'), 0,
                        wx.LEFT, 4),
                    ), 0, wx.EXPAND | wx.LEFT | wx.RIGHT | wx.BOTTOM, 6),
                )
                dialog.SetSizer(sizer)
                backup = barb.BackupSettings(bashFrame,
                    backup_images=dialog.ShowModal())
                backup.Apply()
        except StateError:
            backup.WarnFailed()
...
class User_RestoreSettings(Link):
    ...
    def AppendToMenu(self, menu, window, data):
        Link.AppendToMenu(self, menu, window, data)
        menuItem = wx.MenuItem(menu, self.id, _('Restore Settings...'),
            help="Restore all of Wrye Flash's settings/data from a backup archive file.",
            kind=wx.ITEM_CHECK)
        menu.AppendItem(menuItem)
    ...
    def Execute(self, event):
        try:
            ...
            if backup.PromptConfirm():
                backup.restore_images = balt.askYes(self.window, _(
...
class User_SaveSettings(Link):
    ...
    def AppendToMenu(self, menu, window, data):
        Link.AppendToMenu(self, menu, window, data)
        menuItem = wx.MenuItem(menu, self.id, _('Save Settings'),
            help="Save all of Wrye Flash's settings/data now.",
            kind=wx.ITEM_CHECK)
        menu.AppendItem(menuItem)
...
class Mods_UpdateInvalidator(Link):
    ...
    def Execute(self, event):
        ...
        if not balt.askContinue(self.window, message, 'bash.updateAI.continue',
            _('ArchiveInvalidation.txt')):
            return
...
class Mod_ActorLevels_Export(Link):
    ...
    def Execute(self, event):
        ...
        if not balt.askContinue(self.window, message,
            'bash.actorLevels.export.continue', _('Export NPC Levels')):
            return
        fileName = GPath(self.data[0])
...
class Mod_ActorLevels_Import(Link):
    ...
    def Execute(self, event):
        ...
        if not balt.askContinue(self.window, message,
            'bash.actorLevels.import.continue', _('Import NPC Levels')):
            return
        fileName = GPath(self.data[0])
        fileInfo = bosh.modInfos[fileName]
        textName = fileName.root + _('_NPC_Levels.csv')
        ...
        if ext != '.csv':
            balt.showError(self.window,
                _('Source file must be a _NPC_Levels.csv file.'))
            return
        # --Export
        changed = None
        ...
        # --Log
        if not changed:
            balt.showOk(self.window, _("No relevant NPC levels to import."),
                _("Import NPC Levels"))
        else:
            buff = stringBuffer()
            buff.write('* %03d  %s\n' % (changed, fileName.s))
            balt.showLog(self.window, buff.getvalue(), _('Import NPC Levels'),
                icons=bashBlue)
...
class Mod_AddMaster(Link):
    ...
    def Execute(self, event):
        ...
        if not balt.askContinue(self.window, message, 'bash.addMaster.continue',
            _('Add Master')):
            return
        fileName = GPath(self.data[0])
        fileInfo = self.window.data[fileName]
        wildcard = _('FalloutNV Masters') + ' (*.esm;*.esp)|*.esm;*.esp'
        masterPath = balt.askOpen(self.window, _('Add master:'), fileInfo.dir,
...
class Mod_BaloGroups_Edit(wx.Dialog):
    ...
    def __init__(self, parent):
        ...
        self.removed = set()
        # --GUI
        wx.Dialog.__init__(self, parent, -1, _("Balo Groups"),
            style=wx.CAPTION | wx.RESIZE_BORDER)
        # --List
        self.gList = wx.ListBox(self, -1, choices=self.GetItems(),
            style=wx.LB_SINGLE)
        self.gList.SetSizeHints(125, 150)
        self.gList.Bind(wx.EVT_LISTBOX, self.DoSelect)
        # --Bounds
        self.gLowerBounds = spinCtrl(self, '-10', size=(15, 15), min=-10, max=0,
            onSpin=self.OnSpin)
        self.gUpperBounds = spinCtrl(self, '10', size=(15, 15), min=0, max=10,
            onSpin=self.OnSpin)
        ...
        self.gMoveEarlier = button(self, _('Move Up'),
            onClick=self.DoMoveEarlier)
    ...
    def AskNewName(self, message, title):
        ...
        if not maValid or maValid.group(1) != newName:
            showWarning(self,
                _("Group name must be letters, spaces, underscores only!"),
                title)
            return None
            ...
            showWarning(self,
                _("Group names must be less than forty characters."), title)
            return None
        else:
            return newName
    ...
    def DoRename(self, event):
        ...
        message = _("Rename %s to (spaces, letters and underscores only):") % (
        oldName,)
        newName = self.AskNewName(message, title)
        if newName:
...
class Mod_BaloGroups:
    ...
    def AppendToMenu(self, menu, window, data):
        ...
        setableMods = [GPath(x) for x in self.data if
            GPath(x) not in bosh.modInfos.autoHeaders]
        if setableMods:
            menu.AppendSeparator()
        ...
        wx.EVT_MENU_RANGE(bashFrame, self.idList.BASE, self.idList.MAX,
            self.DoList)
...
class Mod_CreateBOSSReport(Link):
    ...
    def Execute(self, event):
        ...
        if settings['bash.CBashEnabled']:
            ...
            try:
                with balt.Progress(_("Dirty Edits"), '\n' + ' ' * 60,
                    ...
                    udr_itm_fog = bosh.ModCleaner.scan_Many(modInfos,
                        progress=progress)
        ...
        for i, fileName in enumerate(self.data):
            ...
            if not installer:
                ...
                if ma and ma.group(2):
                    url = 'http://www.nexusmods.com/newvegas/mods/' + ma.group(
                        2)
                # if not url:
        ...
        if (wx.TheClipboard.Open()):
            wx.TheClipboard.SetData(wx.TextDataObject(text))
            wx.TheClipboard.Close()
        balt.showLog(self.window, text, _("BOSS Report"), asDialog=False,
            fixedFont=False, icons=bashBlue)
...
class Mod_AllowInvertGhosting(Link):
    ...
    def Execute(self, event):
        ...
        for fileName in self.data:
            fileInfo = bosh.modInfos[fileName]
            allowGhosting = bosh.modInfos.table.getItem(fileName,
                'allowGhosting', True) ^ True
            bosh.modInfos.table.setItem(fileName, 'allowGhosting',
                allowGhosting)
...
class Mod_AllowGhosting(Link):
    ...
    def AppendToMenu(self, menu, window, data):
        Link.AppendToMenu(self, menu, window, data)
        if len(data) == 1:
            menuItem = wx.MenuItem(menu, self.id, _("Don't Ghost"),
                kind=wx.ITEM_CHECK)
            menu.AppendItem(menuItem)
            self.allowGhosting = bosh.modInfos.table.getItem(data[0],
                'allowGhosting', True)
...
class Mod_SkipDirtyCheckAll(Link):
    ...
    def AppendToMenu(self, menu, window, data):
        ...
        if self.skip:
            menuItem = wx.MenuItem(menu, self.id,
                _("Don't check against BOSS's dirty mod list"))
        else:
            menuItem = wx.MenuItem(menu, self.id,
                _("Check against BOSS's dirty mod list"))
        menu.AppendItem(menuItem)
...
class Mod_SkipDirtyCheckInvert(Link):
    def AppendToMenu(self, menu, window, data):
        Link.AppendToMenu(self, menu, window, data)
        menuItem = wx.MenuItem(menu, self.id,
            _("Invert checking against BOSS's dirty mod list"))
        menu.AppendItem(menuItem)

    def Execute(self, event):
        for fileName in self.data:
            fileInfo = bosh.modInfos[fileName]
            ignoreDiry = bosh.modInfos.table.getItem(fileName, 'ignoreDirty',
                False) ^ True
    ...
    def AppendToMenu(self, menu, window, data):
        ...
        if len(data) == 1:
            menuItem = wx.MenuItem(menu, self.id,
                ...
                kind=wx.ITEM_CHECK)
            menu.AppendItem(menuItem)
            self.ignoreDirty = bosh.modInfos.table.getItem(data[0],
                'ignoreDirty', False)
        ...
        with balt.Progress(_("Nvidia Fog Fix")) as progress:
            ...
            for index, fileName in enumerate(map(GPath, self.data)):
                ...
                if cleanMod.fixedCells:
                    fixed.append(
                        '* %4d %s' % (len(cleanMod.fixedCells), fileName.s))
            progress.Destroy()
            if fixed:
                message = _("===Cells Fixed:\n") + ('\n'.join(fixed))
                balt.showWryeLog(self.window, message, _('Nvidia Fog Fix'),
                    icons=bashBlue)
            else:
...
class Mod_FactionRelations_Export(Link):
    ...
    def Execute(self, event):
        ...
        textDir.makedirs()
        # --File dialog
        textPath = balt.askSave(self.window, _('Export faction relations to:'),
            textDir, textName, '*Relations.csv')
        if not textPath: return
        (textDir, textName) = textPath.headTail
        # --Export
...
class Mod_FactionRelations_Import(Link):
    ...
    def Execute(self, event):
        ...
        if not balt.askContinue(self.window, message,
            'bash.factionRelations.import.continue', _('Import Relations')):
            return
        fileName = GPath(self.data[0])
        fileInfo = bosh.modInfos[fileName]
        textName = fileName.root + _('_Relations.csv')
        ...
        textPath = balt.askOpen(self.window,
            _('Import faction relations from:'),
        ...
        if ext != '.csv':
            balt.showError(self.window,
                _('Source file must be a _Relations.csv file.'))
            return
        # --Export
        changed = None
        ...
        if not changed:
            balt.showOk(self.window,
                _("No relevant faction relations to import."),
                _("Import Relations"))
        else:
            buff = stringBuffer()
            buff.write('* %03d  %s\n' % (changed, fileName.s))
            balt.showLog(self.window, buff.getvalue(), _('Import Relations'),
                icons=bashBlue)
...
class Mod_Factions_Export(Link):
    ...
    def Execute(self, event):
        ...
        textDir.makedirs()
        # --File dialog
        textPath = balt.askSave(self.window, _('Export factions to:'), textDir,
            textName, '*Factions.csv')
        if not textPath: return
        (textDir, textName) = textPath.headTail
        # --Export
        with balt.Progress(_("Export Factions")) as progress:
...
class Mod_Factions_Import(Link):
    ...
    def Execute(self, event):
        ...
        if not balt.askContinue(self.window, message,
            'bash.factionRanks.import.continue', _('Import Factions')):
            return
        fileName = GPath(self.data[0])
        fileInfo = bosh.modInfos[fileName]
        textName = fileName.root + _('_Factions.csv')
        ...
        if ext != '.csv':
            balt.showError(self.window,
                _('Source file must be a _Factions.csv file.'))
            return
        # --Export
        changed = None
        ...
        # --Log
        if not changed:
            balt.showOk(self.window, _("No relevant faction ranks to import."),
                _("Import Factions"))
        else:
            buff = stringBuffer()
            ...
            balt.showLog(self.window, buff.getvalue(), _('Import Factions'),
                icons=bashBlue)
...
class Mod_MarkMergeable(Link):
    ...
    def Execute(self, event):
        ...
        if message != '':
            balt.showWryeLog(self.window, message, _('Mark Mergeable'),
                icons=bashBlue)
        ...
        for item in self.data:
            ...
            if modsDir.join(newName).exists():
                if not balt.askYes(self.window,
                        _('Replace existing %s?') % (newName.s,), self.label):
                    continue
...
class Mod_Face_Import(Link):
    ...
    def Execute(self, event):
        ...
        # --File dialog
        srcPath = balt.askOpen(self.window, 'Face Source:', srcDir, '',
            wildcard, mustExist=True)
        ...
        self.window.RefreshUI()
        balt.showOk(self.window, _('Imported face to: %s') % (npc.eid,),
            fileName.s)
...
class Mod_FlipMasters(Link):
    ...
    def AppendToMenu(self, menu, window, data):
        ...
        if len(data) == 1 and len(fileInfo.header.masters) > 1:
            espMasters = [master for master in fileInfo.header.masters if
                bosh.reEspExt.search(master.s)]
...
class Mod_FlipSelf(Link):
    ...
    def Execute(self, event):
        ...
        if not balt.askContinue(self.window, message,
            'bash.flipToEsmp.continue', _('Flip to Esm')):
            return
        for item in self.data:
            fileInfo = bosh.modInfos[item]
...
class Mod_Labels:
    ...
    def DoList(self, event):
        ...
        if isinstance(self, Mod_Groups) and bosh.modInfos.refresh(
            doInfos=False):
            modList.SortItems()
        self.window.RefreshUI()
...
class Mod_Groups_Export(Link):
    ...
    def Execute(self, event):
        ...
        textDir.makedirs()
        # --File dialog
        textPath = balt.askSave(self.window, _('Export groups to:'), textDir,
            textName, '*Groups.csv')
        if not textPath: return
        (textDir, textName) = textPath.headTail
        # --Export
...
class Mod_Groups_Import(Link):
    ...
    def Execute(self, event):
        ...
        self.window.RefreshUI()
        balt.showOk(self.window,
            _("Imported %d mod/groups (%d changed).") % (
            len(modGroups.mod_group), changed),
            _("Import Groups"))
...
class Mod_EditorIds_Export(Link):
    ...
    def Execute(self, event):
        ...
        textDir.makedirs()
        # --File dialog
        textPath = balt.askSave(self.window, _('Export eids to:'), textDir,
            textName, '*Eids.csv')
        if not textPath: return
        (textDir, textName) = textPath.headTail
        # --Export
...
class Mod_EditorIds_Import(Link):
    ...
    def Execute(self, event):
        ...
        if not changed:
            ...
            balt.showLog(self.window, buff.getvalue(), _('Objects Changed'),
                icons=bashBlue)
...
class Mod_DecompileAll(Link):
    ...
    def AppendToMenu(self, menu, window, data):
        ...
        menu.AppendItem(menuItem)
        menuItem.Enable(
            len(self.data) != 1 or (not bosh.reFallout.match(self.data[0].s)))
    ...
    def Execute(self, event):
        ...
        if not balt.askContinue(self.window, message,
            'bash.decompileAll.continue', _('Decompile All')):
            return
        for item in self.data:
            fileName = GPath(item)
            if bosh.reFallout.match(fileName.s):
                balt.showWarning(self.window, _("Skipping %s") % fileName.s,
                    _('Decompile All'))
                continue
            fileInfo = bosh.modInfos[fileName]
            ...
            if modFile.SCPT.getNumRecords(False):
                ...
                for master in modFile.tes4.masters:
                    masterFile = bosh.ModFile(bosh.modInfos[master],
                        loadFactory)
            ...
            if len(removed) >= 50 or badGenericLore:
                ...
                balt.showOk(self.window,
                    _("Scripts removed: %d.\nScripts remaining: %d") % (
                    len(removed), len(modFile.SCPT.records)), fileName.s)
            elif removed:
                balt.showOk(self.window, _(
                    "Only %d scripts were identical. This is probably intentional, so no changes have been made.") % len(
                    removed), fileName.s)
            else:
...
class Mod_Fids_Replace(Link):
    ...
    def Execute(self, event):
        ...
        if not changed:
            ...
            balt.showLog(self.window, changed, _('Objects Changed'),
                icons=bashBlue)
...
class Mod_FullNames_Import(Link):
    ...
    def Execute(self, event):
        ...
        if ext not in ('.esp', '.esm', '.csv'):
            balt.showError(self.window,
                _('Source file must be mod (.esp or .esm) or csv file.'))
            return
        # --Export
        renamed = None
        ...
        if not renamed:
            ...
            balt.showLog(self.window, buff.getvalue(), _('Objects Renamed'),
                icons=bashBlue)
...
class Mod_Patch_Update(Link):
    ...
    def AppendToMenu(self, menu, window, data):
        ...
        enable = (len(self.data) == 1 and
                  bosh.modInfos[self.data[0]].header.author in (
                  'BASHED PATCH', 'BASHED LISTS'))
        check = False
    ...
    def Execute(self, event):
        ...
        fileInfo = bosh.modInfos[fileName]
        if not bosh.modInfos.ordered:
            balt.showWarning(self.window, _(
        ...
        if self.doCBash and not balt.askContinue(self.window,
            _(
                "Building with CBash is cool.  It's faster and allows more things to be handled, but it is still in BETA.  If you have problems, post them in the official thread, then use the non-CBash build function."),
        ...
        if self.CBashMismatch:
            if not balt.askContinue(self.window,
                    _(
                        "The patch you are rebuilding (%s) was created in %s mode.  You are trying to rebuild it using %s mode.  Wrye Flash will attempt to import your settings over, however some may not be copied correctly.")
                    % (self.data[0].s, ['CBash', 'Python'][self.doCBash],
        ...
        with balt.BusyCursor():  # just to show users that it hasn't stalled but is doing stuff.
            if not self.doCBash:
                ...
                if settings['bash.CBashEnabled']:
                    ...
                    with balt.Progress(
                            _("Mark Mergeable") + ' ' * 30) as progress:
                        bosh.modInfos.rescanMergeable(bosh.modInfos.data,
                            progress, False)
                    self.window.RefreshUI()
            else:
            ...
            unfiltered = [x for x in ActivePriortoPatch if
                'Filter' in bosh.modInfos[x].getBashTags()]
            merge = [x for x in ActivePriortoPatch if
                'NoMerge' not in bosh.modInfos[
                    x].getBashTags() and x in bosh.modInfos.mergeable]
            noMerge = [x for x in ActivePriortoPatch if
                'NoMerge' in bosh.modInfos[
                    x].getBashTags() and x in bosh.modInfos.mergeable]
            deactivate = [x for x in ActivePriortoPatch if
                'Deactivate' in bosh.modInfos[
                    x].getBashTags() and not 'Filter' in bosh.modInfos[
                    x].getBashTags()]
            if deactivate: message += _(
                "The following mods are tagged 'Deactivate'. These should be deactivated before building the patch, and then imported into the patch during build.\n*%s") % (
                                      '\n* '.join(
                                          x.s for x in deactivate)) + '\n\n'
            if unfiltered: message += _(
        ...
        if message:
            ...
            if balt.showLog(self.window, message,
                _('Deactivate Suggested Mods?'), icons=bashBlue, question=True):
                with balt.BusyCursor():
                    if deactivate:
        ...
        if text:
            warning = balt.askYes(self.window, (_(
                'WARNING!\nThe following mod(s) have master file error(s):\n%sPlease adjust your load order to rectify those probem(s) before continuing. However you can still proceed if you want to. Proceed?') % (
                                                text)),
                _("Missing or Delinquent Master Errors"))
            if not warning:
                return
        try:
...
class Mod_ListPatchConfig(Link):
    ...
    def Execute(self, event):
        ...
        for patcher in patchers:
            ...
            if isinstance(patcher, bosh.CBash_MultiTweaker) or isinstance(
                patcher, bosh.MultiTweaker):
                # Tweak patcher
            ...
            elif isinstance(patcher,
                (bosh.CBash_AliasesPatcher, bosh.AliasesPatcher)):
                # Alias mod names
        ...
        balt.showWryeLog(self.window, log.out.getvalue(),
            _('Bashed Patch Configuration'), icons=bashBlue)
...
class Mod_SetVersion(Link):
    ...
    def AppendToMenu(self, menu, window, data):
        ...
        menuItem.Enable((len(data) == 1) and (
        int(100 * self.fileInfo.header.version) != 132))

    def Execute(self, event):
        message = _(
            "WARNING! For advanced modders only! This feature allows you to edit newer official mods in the GECK by resetting the internal file version number back to 1.32. While this will make the mod editable, it may also break the mod in some way.")
        if not balt.askContinue(self.window, message,
            'bash.setModVersion.continue', _('Set File Version')):
            return
        ...
        with balt.Progress(modName.s) as progress:
            ...
            for group in sorted(modDetails.group_records):
                ...
                if group in ('CELL', 'WRLD', 'DIAL'):
                    buff.write(
                        _('  (Details not provided for this record type.)\n\n'))
                    continue
...
class Mod_RemoveWorldOrphans(Link):
    ...
    def Execute(self, event):
        ...
        if not balt.askContinue(self.window, message,
            'bash.removeWorldOrphans.continue', _('Remove World Orphans')):
            return
        for item in self.data:
            fileName = GPath(item)
            if bosh.reFallout.match(fileName.s):
            ...
            with balt.Progress(_("Remove World Orphans")) as progress:
                ...
                orphans = (
                          'WRLD' in modFile.tops) and modFile.WRLD.orphansSkipped
                if orphans:
            ...
            if orphans:
                balt.showOk(self.window,
                    _("Orphan cell blocks removed: %d.") % (orphans,),
                    fileName.s)
            else:
                balt.showOk(self.window, _("No changes required."), fileName.s)
...
class Mod_Scripts_Export(Link):
    ...
    def Execute(self, event):
        fileName = GPath(self.data[0])
        fileInfo = bosh.modInfos[fileName]
        defaultPath = bosh.dirs['patches'].join(
            fileName.s + ' Exported Scripts')
        skip = balt.askText(self.window, _(
            'Skip prefix (leave blank to not skip any), non-case sensitive):'),
            _('Skip Prefix?'), '')
        if skip == None: return
        deprefix = balt.askText(self.window, _(
        ...
        exportedScripts = ScriptText.writeToText(fileInfo, skip, textDir,
            deprefix, fileName.s)
        # finally:
        balt.showLog(self.window, exportedScripts, _('Export Scripts'),
            icons=bashBlue)
...
class Mod_Scripts_Import(Link):
    ...
    def Execute(self, event):
        ...
        makeNew = balt.askYes(self.window, message, _('Import Scripts'),
        ...
        if not (len(changed) or len(added)):
            balt.showOk(self.window, _("No changed or new scripts to import."),
                _("Import Scripts"))
        else:
            if changed:
                changedScripts = (
                _('Imported %d changed scripts from %s:\n%s') % (
            ...
            if changed and added:
                ...
                report = addedScripts
            balt.showLog(self.window, report, _('Import Scripts'),
                icons=bashBlue)
...
class Mod_Stats_Import(Link):
    ...
    def Execute(self, event):
        ...
        if ext != '.csv':
            balt.showError(self.window,
                _('Source file must be a Stats.csv file.'))
            return
        # --Export
        changed = None
        ...
        # --Log
        if not changed:
            balt.showOk(self.window, _("No relevant stats to import."),
                _("Import Stats"))
        else:
            if not len(changed):
                balt.showOk(self.window, _("No changed stats to import."),
                    _("Import Stats"))
            else:
                buff = stringBuffer()
                for modName in sorted(changed):
                    buff.write('* %03d  %s:\n' % (changed[modName], modName.s))
                balt.showLog(self.window, buff.getvalue(), _('Import Stats'),
                    icons=bashBlue)
...
class Mod_ItemData_Import(Link):
    ...
    def Execute(self, event):
        ...
        if ext != '.csv':
            balt.showError(self.window,
                _('Source file must be a ItemData.csv file.'))
            return
        # --Export
        changed = None
        ...
        # --Log
        if not changed:
            balt.showOk(self.window, _("No relevant data to import."),
                _("Import Item Data"))
        else:
            buff = stringBuffer()
            for modName in sorted(changed):
                ...
                changed[modName], modName.s))
            balt.showLog(self.window, buff.getvalue(), _('Import Item Data'),
                icons=bashBlue)
...
class Mod_Prices_Import(Link):
    ...
    def Execute(self, event):
        ...
        if ext not in ['.csv', '.ghost', '.esm', '.esp']:
            balt.showError(self.window,
                _('Source file must be a Prices.csv file or esp/m.'))
            return
        # --Export
        changed = None
        ...
        # --Log
        if not changed:
            balt.showOk(self.window, _("No relevant prices to import."),
                _("Import Prices"))
        else:
            buff = stringBuffer()
            for modName in sorted(changed):
            ...
            balt.showLog(self.window, buff.getvalue(), _('Import Prices'),
                icons=bashBlue)
...
class CBash_Mod_MapMarkers_Import(Link):
    ...
    def Execute(self, event):
        ...
        if not balt.askContinue(self.window, message,
            'bash.MapMarkers.import.continue',
        ...
        if ext not in ['.csv']:
            balt.showError(self.window,
                _('Source file must be a MapMarkers.csv file'))
            return
        # --Export
        changed = None
        ...
        # --Log
        if not changed:
            balt.showOk(self.window, _("No relevant Map Markers to import."),
                _("Import Map Markers"))
        else:
            buff = stringBuffer()
            ...
            for eid in sorted(changed):
                buff.write('* %s\n' % (eid))
            balt.showLog(self.window, buff.getvalue(), _('Import Map Markers'),
                icons=bashBlue)
...
class Mod_SigilStoneDetails_Export(Link):
    ...
    def Execute(self, event):
        ...
        textPath = balt.askSave(self.window,
            _('Export Sigil Stone details to:'), textDir, textName,
            '*_SigilStones.csv')
        if not textPath: return
        (textDir, textName) = textPath.headTail
        # --Export
...
class Mod_SigilStoneDetails_Import(Link):
    ...
    def Execute(self, event):
        ...
        # --File dialog
        textPath = balt.askOpen(self.window,
            _('Import Sigil Stone details from:'),
        ...
        if ext not in ['.csv']:
            balt.showError(self.window,
                _('Source file must be a _SigilStones.csv file'))
            return
        # --Export
        changed = None
        ...
        if not changed:
            balt.showOk(self.window,
                _("No relevant Sigil Stone details to import."),
                _("Import Sigil Stone details"))
        else:
            buff = stringBuffer()
            buff.write(
                'Imported Sigil Stone details to mod %s:\n' % (fileName.s,))
            for eid in sorted(changed):
                buff.write('* %s\n' % (eid))
            balt.showLog(self.window, buff.getvalue(),
                _('Import Sigil Stone details'), icons=bashBlue)
...
class Mod_SpellRecords_Export(Link):
    ...
    def Execute(self, event):
        ...
        textDir.makedirs()
        # --File dialog
        textPath = balt.askSave(self.window, _('Export Spell details to:'),
            textDir, textName, '*_Spells.csv')
        if not textPath: return
        message = _(
            "Export flags and effects?\n(If not they will just be skipped).")
        doDetailed = balt.askYes(self.window, message, _('Export Spells'),
            icon=wx.ICON_QUESTION)
        (textDir, textName) = textPath.headTail
        # --Export
...
class Mod_SpellRecords_Import(Link):
    ...
    def Execute(self, event):
        ...
        doDetailed = balt.askYes(self.window, message,
            _('Import Spell details'), icon=wx.ICON_QUESTION)
        (textDir, textName) = textPath.headTail
        # --Extension error check
        ext = textName.cext
        if ext not in ['.csv']:
            balt.showError(self.window,
                _('Source file must be a _Spells.csv file'))
            return
        # --Export
        changed = None
        ...
        # --Log
        if not changed:
            balt.showOk(self.window, _("No relevant Spell details to import."),
                _("Import Spell details"))
        else:
            buff = stringBuffer()
            ...
            for eid in sorted(changed):
                buff.write('* %s\n' % (eid))
            balt.showLog(self.window, buff.getvalue(),
                _('Import Spell details'), icons=bashBlue)
...
class Mod_IngredientDetails_Export(Link):
    ...
    def Execute(self, event):
        ...
        textDir.makedirs()
        # --File dialog
        textPath = balt.askSave(self.window, _('Export Ingredient details to:'),
            textDir, textName, '*_Ingredients.csv')
        if not textPath: return
        (textDir, textName) = textPath.headTail
        # --Export
...
class Mod_IngredientDetails_Import(Link):
    ...
    def Execute(self, event):
        ...
        # --File dialog
        textPath = balt.askOpen(self.window,
            _('Import Ingredient details from:'),
        ...
        if ext not in ['.csv']:
            balt.showError(self.window,
                _('Source file must be a _Ingredients.csv file'))
            return
        # --Export
        changed = None
        ...
        if not changed:
            balt.showOk(self.window,
                _("No relevant Ingredient details to import."),
                _("Import Ingredient details"))
        else:
            buff = stringBuffer()
            buff.write(
                'Imported Ingredient details to mod %s:\n' % (fileName.s,))
            for eid in sorted(changed):
                buff.write('* %s\n' % (eid))
            balt.showLog(self.window, buff.getvalue(),
                _('Import Ingredient details'), icons=bashBlue)
    ...
    def Execute(self, event):
        ...
        with balt.Progress(_("Undelete Refs")) as progress:
            ...
            for index, fileName in enumerate(map(GPath, self.data)):
                ...
                cleaner.clean(bosh.ModCleaner.UDR,
        ...
        if hasFixed:
            ...
            balt.showWryeLog(self.window, message, _('Undelete Refs'),
                icons=bashBlue)
        else:
            message = _("No changes required.")
...
class Mod_ScanDirty(Link):
    ...
    def Execute(self, event):
        ...
        for i, modInfo in enumerate(modInfos):
            ...
            if modInfo.header.author in (
            'BASHED PATCH', 'BASHED LISTS'): itm = set()
            if udr or itm:
        ...
        # -- Show log
        balt.showWryeLog(self.window, log.out.getvalue(),
            _('Dirty Edit Scan Results'), asDialog=False, icons=bashBlue)
...
class Saves_ProfilesData(balt.ListEditorData):
    ...
    def add(self):
        ...
        bosh.saveInfos.profiles.setItem(newSaves, 'vFalloutNV',
    ...
    def rename(self, oldName, newName):
        ...
        if len(newName) == 0 or len(newName) > 64:
            ...
            return False
        # --Rename
        oldDir, newDir = (self.baseSaves.join(dir) for dir in
        (oldName, newName))
        oldDir.moveTo(newDir)
        oldSaves, newSaves = (('Saves\\' + name + '\\') for name in
        (oldName, newName))
    ...
    def remove(self, profile):
        ...
        files = [file for file in profileDir.list() if
            bosh.reSaveExt.search(file.s)]
        if files:
            message = _(
        ...
        if GPath('FalloutNV/Saves').s not in profileDir.s:
            raise BoltError(
                _('Sanity check failed: No "FalloutNV\\Saves" in %s.') % (
                profileDir.s,))
...
class Saves_Profiles:
    ...
    def AppendToMenu(self, menu, window, data):
        ...
        menuItem = wx.MenuItem(menu, self.idList.DEFAULT, _('Default'),
            kind=wx.ITEM_CHECK)
        menu.AppendItem(menuItem)
    ...
    def swapFalloutVersion(self, newSaves):
        ...
        voNew = bosh.saveInfos.profiles.setItemDefault(newSaves, 'vFalloutNV',
            bosh.modInfos.voCurrent)
...
class Save_ImportFace(Link):
    ...
    def Execute(self, event):
        ...
        srcDir = fileInfo.dir
        wildcard = _(
            'FalloutNV Files') + ' (*.esp;*.esm;*.fos;*.for)|*.esp;*.esm;*.fos;*.for'
        # --File dialog
        srcPath = balt.askOpen(self.window, 'Face Source:', srcDir, '',
            wildcard, mustExist=True)
        if not srcPath: return
    ...
    def FromMod(self, fileInfo, srcPath):
        ...
        if not srcFaces:
            balt.showOk(self.window,
                _('No player (PC) faces found in %s.') % (srcName.s,),
                srcName.s)
            return
        # --Dialog
        dialog = ImportFaceDialog(self.window, -1, srcName.s, fileInfo,
...
class Save_RenamePlayer(Link):
    ...
    def Execute(self, event):
        ...
        newName = balt.askText(self.window,
            _("Enter new player name. E.g. Conan the Bold"),
...
class Save_ExportScreenshot(Link):
    ...
    def Execute(self, event):
        saveInfo = bosh.saveInfos[self.data[0]]
        imagePath = balt.askSave(bashFrame, _('Save Screenshot as:'),
            bosh.dirs['patches'].s, 'Screenshot %s.jpg' % self.data[0].s,
            '*.jpg')
    ...
    def Execute(self, event):
        ...
        if not missing and not extra:
            ...
            if missing:
                ...
                message += '\n* '.join(
                    x.s for x in bosh.modInfos.getOrdered(missing))
                if extra: message += '\n\n'
            if extra:
                message += _("=== Added Masters (%s):\n* ") % (newName.s,)
                message += '\n* '.join(
                    x.s for x in bosh.modInfos.getOrdered(extra))
...
class Save_Renumber(Link):
    ...
    def Execute(self, event):
        # --File Info
        newNumber = balt.askNumber(self.window,
            _("Enter new number to start numbering the selected saves at."),
            prompt=_('Save Number'), title=_('Re-number Saves'), value=1, min=1,
            max=10000)
...
class Save_EditCreatedData(balt.ListEditorData):
    ...
    def __init__(self, parent, saveFile, recordTypes):
        ...
        for index, record in enumerate(saveFile.created):
            if record.recType == 'ENCH':
                ...
                if record_full not in data: data[record_full] = (
                record_full, [])
    ...
    def getInfo(self, item):
        ...
        if hasattr(record,
            'enchantment') and record.enchantment in self.enchantments:
            buff.write('\nEnchantment:\n')
    ...
    def save(self):
        ...
        if not self.changed:
            ...
            balt.showOk(self.parent, _("Names modified: %d.") % (count,),
                self.saveFile.fileInfo.name.s)


# ------------------------------------------------------------------------------
class Save_EditCreated(Link):
    """Allows user to rename custom items (spells, enchantments, etc)."""
    menuNames = {'ENCH': _('Rename Enchanted...'),
        'SPEL'         : _('Rename Spells...'), 'ALCH': _('Rename Potions...')}
    ...
    def Execute(self, event):
        ...
        records = [record for record in saveFile.created if
            record.recType in recordTypes]
        if not records:
...
class Save_EditCreatedEnchantmentCosts(Link):
    ...
    def AppendToMenu(self, menu, window, data):
        ...
        Link.AppendToMenu(self, menu, window, data)
        menuItem = wx.MenuItem(menu, self.id,
            _('Set Number of Uses for Weapon Enchantments...'))
        menu.AppendItem(menuItem)
        menuItem.Enable(len(data) == 1)
...
class Save_Move:
    ...
    def MoveFiles(self, profile):
        ...
        if destDir == fileInfos.dir:
            balt.showError(self.window,
                _("You can't move saves to the current profile!"))
            return
        savesTable = bosh.saveInfos.table
        # --bashDir
        destTable = bolt.Table(
            bosh.PickleDict(destDir.join('Bash', 'Table.dat')))
        count = 0
        ask = True
        for fileName in self.data:
            if ask and not self.window.data.moveIsSafe(fileName, destDir):
                message = (
                _('A file named %s already exists in %s. Overwrite it?')
                % (fileName.s, profile))
                result = balt.askContinueShortTerm(self.window, message,
                    _('Move File'))
                # if result is true just do the job but ask next time if applicable as well
                if not result:
                    continue
                elif result == 2:
                    ask = False  # so don't warn for rest of operation
            if self.copyMode:
        ...
        if self.copyMode:
            balt.showInfo(self.window,
                _('%d files copied to %s.') % (count, profile), _('Copy File'))
...
class Save_RepairAbomb(Link):
    ...
    def Execute(self, event):
        ...
        # --Continue?
        progress = 100 * abombFloat / \
                   struct.unpack('f', struct.pack('I', 0x49000000))[0]
        newCounter = 0x41000000
        if abombCounter <= newCounter:
            balt.showOk(self.window, _('Abomb counter is too low to reset.'),
                _('Repair Abomb'))
            return
        message = _(
        ...
        if balt.askYes(self.window, message, _('Repair Abomb'), default=False):
            ...
            saveFile.safeSave()
            balt.showOk(self.window, _('Abomb counter reset.'),
                _('Repair Abomb'))
...
class Save_RepairFactions(Link):
    ...
    def Execute(self, event):
        debug = False
        message = _(
            'This will (mostly) repair faction membership errors due to Wrye Flash v 105 bug and/or faction changes in underlying mods.\n\nWARNING! This repair is NOT perfect! Do not use it unless you have to!')
        if not balt.askContinue(self.window, message,
            'bash.repairFactions.continue', _('Update NPC Levels')):
            return
        question = _(
            "Restore dropped factions too? WARNING: This may involve clicking through a LOT of yes/no dialogs.")
        restoreDropped = balt.askYes(self.window, question,
            _('Repair Factions'), default=False)
        ...
        with balt.Progress(_('Repair Factions')) as progress:
            ...
            for index, modName in enumerate(ordered):
                ...
                modFile.load(True)
                # --Loop over mod NPCs
                mapToOrdered = bosh.MasterMap(modFile.tes4.masters + [modName],
                    ordered)
                ...
                for recNum in xrange(len(records)):
                    ...
                    if recId == 7:
                        ...
                        if (npc.factions != None and
                                playerFactionIref not in [iref for iref, level
                                in npc.factions]
                        ):
                            log('. %08X %s -- **PlayerFaction, 0**' % (
                            recId, eid))
                    ...
                    # --Compare to mod data
                        ...
                        if npc.factions and factions:
                            curFactions = set(
                                [iref for iref, level in npc.factions])
                            for orderedId, level in factions:
                                fid = mapToSave(orderedId, None)
                                if not fid: continue
                                iref = saveFile.getIref(fid)
                                if iref not in curFactions and (
                                recId, fid) not in legitDroppedFactions:
                                    factEid = fact_eid.get(orderedId, '------')
                                    question = _(
                                        'Restore %s to %s faction?') % (
                                               npcEid, factEid)
                                    if debug:
                                        print 'refactioned %08X %08X %s %s' % (
                                        recId, fid, npcEid, factEid)
                                    elif not balt.askYes(self.window, question,
                                        saveName.s, default=False):
                                        continue
                                    log('. %08X %s -- **%s, %d**' % (
                                    recId, eid, factEid, level))
                                    npc.factions.append((iref, level))
                                    refactioned = True
                    refactionedCount += (0, 1)[refactioned]
                    # --Save record changes?
                    if unNulled or refactioned:
                        saveFile.records[recNum] = (
                        recId, recType, npc.getFlags(), version, npc.getData())
                # --Save changes?
                subProgress(index + 0.5, _("Updating ") + saveName.s)
                if unNulledCount or refactionedCount:
                    saveFile.safeSave()
                message += '\n%d %d %s' % (
                refactionedCount, unNulledCount, saveName.s,)
            progress.Destroy()
            # balt.showOk(self.window,message,_('Repair Factions'))
            message = log.out.getvalue()
            balt.showWryeLog(self.window, message, _('Repair Factions'),
                icons=bashBlue)
    ...
    def Execute(self, event):
        ...
        with balt.Progress(_("Reweigh Potions")) as progress:
            ...
            if count:
                ...
                progress.Destroy()
                balt.showOk(self.window, _('Potions reweighed: %d.') % (count,),
                    fileName.s)
            else:
                progress.Destroy()
                balt.showOk(self.window, _('No potions to reweigh!'),
                    fileName.s)
...
class Save_Unbloat(Link):
    ...
    def Execute(self, event):
        ...
        with balt.Progress(_("Scanning for Bloat")) as progress:
            ...
            createdCounts, nullRefCount = saveFile.findBloating(
                SubProgress(progress, 0.8, 1.0))
            progress.Destroy()
            # --Dialog
            ...
            nums = saveFile.removeBloating(createdCounts.keys(), True,
        ...
        with balt.Progress(_('Update NPC Levels')) as progress:
            ...
            for index, modName in enumerate(ordered):
                ...
                for npc in modFile.NPC_.getActiveRecords():
                    ...
                    if not fid: continue
                    npc_info[fid] = (
                    npc.eid, npc.level, npc.calcMin, npc.calcMax,
                    npc.flags.pcLevelOffset)
            # --Loop over savefiles
            subProgress = SubProgress(progress, 0.4, 1.0, len(self.data))
            ...
            for index, saveName in enumerate(self.data):
                ...
                for recNum in xrange(len(records)):
                    ...
                    (eid, level, calcMin, calcMax, pcLevelOffset) = npc_info[
                        orderedRecId]
                    npc = bosh.SreNPC(recFlags, data)
                    acbs = npc.acbs
                    if acbs and (
                        ...
                        (recId, recType, recFlags, version, data) = \
                        saveFile.records[recNum]
                        records[recNum] = (
                        recId, recType, npc.getFlags(), version, npc.getData())
                        releveledCount += 1
...
class Screens_NextScreenShot(Link):
    ...
    def Execute(self, event):
        ...
        base = falloutIni.getSetting('Display', 'sScreenShotBaseName',
            'ScreenShot')
...
class Screen_ConvertTo(Link):
    ...
    def AppendToMenu(self, menu, window, data):
        ...
        menu.AppendItem(menuItem)
        convertable = [name for name in self.data if
            GPath(name).cext != '.' + self.ext]
    ...
    def Execute(self, event):
        ...
        try:
            ...
            for index, fileName in enumerate(self.data):
                ...
                bitmap.SetOptionInt(wx.IMAGE_OPTION_QUALITY,
                    settings['bash.screens.jpgQuality'])
...
class Screen_JpgQualityCustom(Screen_JpgQuality):
    ...
    def __init__(self):
        Screen_JpgQuality.__init__(self,
            settings['bash.screens.jpgCustomQuality'])
        self.label = _('Custom [%i]') % self.quality

    def Execute(self, event):
        quality = balt.askNumber(self.window, _('JPEG Quality'),
...
class Messages_Archive_Import(Link):
    ...
    def Execute(self, event):
        ...
        # --File dialog
        paths = balt.askOpenMulti(self.window, _('Import message archive(s):'),
            textDir,
            '', '*.html')
        if not paths: return
...
class Message_Delete(Link):
    ...
    def Execute(self, event):
        message = _(
            r'Delete these %d message(s)? This operation cannot be undone.') % (
                  len(self.data),)
...
class People_AddNew(Link):
    ...
    def Execute(self, event):
        ...
        if name in self.data:
            return balt.showInfo(self.gTank, name + _(" already exists."),
                self.title)
...
class People_Export(Link):
    ...
    def Execute(self, event):
        textDir = settings.get('bash.workDir', bosh.dirs['app'])
        # --File dialog
        path = balt.askSave(self.gTank, _('Export people to text file:'),
            textDir,
            'People.txt', '*.txt')
        if not path: return
        ...
        balt.showInfo(self.gTank,
            _('Records exported: %d.') % (len(self.selected),), self.title)
...
class People_Import(Link):
    ...
    def Execute(self, event):
        textDir = settings.get('bash.workDir', bosh.dirs['app'])
        # --File dialog
        path = balt.askOpen(self.gTank, _('Import people from text file:'),
            textDir,
            '', '*.txt', mustExist=True)
        if not path: return
        settings['bash.workDir'] = path.head
        newNames = self.data.loadText(path)
        balt.showInfo(self.gTank, _("People imported: %d") % (len(newNames),),
            self.title)
        self.gTank.RefreshUI()
...
class App_Button(Link):
    ...
    def __init__(self, exePathArgs, image, tip, nvseTip=None, nvseArg=None,
        ...
        if self.exePath and self.exePath.ext.lower() == '.jar':  # Sometimes exePath is "None"
            self.isJava = True
            self.java = GPath(os.environ['SYSTEMROOT']).join('system32',
                'javaw.exe')
    ...
    def GetBitmapButton(self, window, style=0):
        if self.IsPresent():
            self.gButton = bitmapButton(window, self.image.GetBitmap(),
                style=style,
    ...
    def Execute(self, event, extraArgs=None):
        if self.IsPresent():
            if self.isJava:
                ...
                exeNvse = bosh.dirs['app'].join('nvse_loader.exe')
                if self.nvseArg != None and settings.get('bash.nvse.on',
                    False) and exeNvse.exists():
                    if bosh.inisettings[
                        'SteamInstall'] and self.exePath.tail.cs == 'falloutnv.exe':
                ...
                try:
                    ...
                    try:
                        import win32api
                        win32api.ShellExecute(0, "open", exePath.s,
                            str(self.exeArgs), bosh.dirs['app'].s, 1)
                    except:
                        print _("Used Path: %s") % exePath.s
                        print _("Used Arguments: "), exeArgs
    ...
    def Execute(self, event, extraArgs=None):
        if self.IsPresent():
            ...
            with balt.Progress(_("Executing BOSS")) as progress:
                ...
                if wx.GetKeyState(
                    67):  # c - print crc calculations in BOSS log.
                    exeArgs += ('-c',)
                ...
                try:
                    subprocess.call((exePath.s,) + exeArgs[1:],
                        startupinfo=bosh.startupinfo, close_fds=bolt.close_fds)
...
class Nvse_Button(Link):
    ...
    def SetState(self, state=None):
        ...
        image = images[('checkbox.green.off.' + bosh.inisettings['IconSize'],
        'checkbox.green.on.' + bosh.inisettings['IconSize'])[state]]
    ...
    def GetBitmapButton(self, window, style=0):
        exeNvse = bosh.dirs['app'].join('nvse_loader.exe')
        if exeNvse.exists():
            bitmap = images['checkbox.green.off.' + bosh.inisettings[
                'IconSize']].GetBitmap()
            self.gButton = bitmapButton(window, bitmap, style=style,
                onClick=self.Execute)
            self.SetState()
            return self.gButton
        else:
...
class AutoQuit_Button(Link):
    ...
    def SetState(self, state=None):
        ...
        image = images[('checkbox.red.off.' + bosh.inisettings['IconSize'],
        'checkbox.red.x.' + bosh.inisettings['IconSize'])[state]]
    ...
    def GetBitmapButton(self, window, style=0):
        bitmap = images[
            'checkbox.red.off.' + bosh.inisettings['IconSize']].GetBitmap()
        self.gButton = bitmapButton(window, bitmap, style=style,
            onClick=self.Execute)
        self.SetState()
        return self.gButton
...
class App_Help(Link):
    ...
    def Execute(self, event):
        ...
        if not html.exists():
            bolt.WryeText.genHtml(bosh.dirs['mopy'].join('Wrye Flash.txt').s,
                None, bosh.dirs['mopy'])
        html.start()
...
class App_DocBrowser(Link):
    ...
    def GetBitmapButton(self, window, style=0):
        ...
        gButton = bitmapButton(window, Image(GPath(bosh.dirs['images'].join(
            'DocBrowser' + bosh.inisettings['IconSize'] + '.png'))).GetBitmap(),
            style=style,
...
class App_ModChecker(Link):
    ...
    def GetBitmapButton(self, window, style=0):
        if not self.id: self.id = wx.NewId()
        gButton = bitmapButton(window, Image(GPath(bosh.dirs['images'].join(
            'ModChecker' + bosh.inisettings['IconSize'] + '.png'))).GetBitmap(),
            style=style,
...
def InitSettings():
    ...
    # --Wrye Balt
    settings['balt.WryeLog.temp'] = bosh.dirs['saveBase'].join(
        'WryeLogTemp.html')
...
def InitImages():
    ...
    # --Standard
    images['save.on'] = Image(GPath(bosh.dirs['images'].join('save_on.png')),
        wx.BITMAP_TYPE_PNG)
    images['save.off'] = Image(GPath(bosh.dirs['images'].join('save_off.png')),
        wx.BITMAP_TYPE_PNG)
    # --Misc
    # images['falloutnv'] = Image(GPath(bosh.dirs['images'].join('falloutnv.png')),wx.BITMAP_TYPE_PNG)
    images['help'] = Image(
        GPath(bosh.dirs['images'].join('help')) + bosh.inisettings[
            'IconSize'] + '.png', wx.BITMAP_TYPE_PNG)
    # --Tools
    images['doc.on'] = Image(
        GPath(bosh.dirs['images'].join('page_find')) + bosh.inisettings[
            'IconSize'] + '.png', wx.BITMAP_TYPE_PNG)
    images['bashmon'] = Image(
        GPath(bosh.dirs['images'].join('bashmon')) + bosh.inisettings[
            'IconSize'] + '.png', wx.BITMAP_TYPE_PNG)
    images['modChecker'] = Image(
        GPath(bosh.dirs['images'].join('table_error')) + bosh.inisettings[
            'IconSize'] + '.png', wx.BITMAP_TYPE_PNG)
    # --ColorChecks
    images['checkbox.red.x'] = Image(
        GPath(bosh.dirs['images'].join('checkbox_red_x.png')),
        wx.BITMAP_TYPE_PNG)
    images['checkbox.red.x.16'] = Image(
        GPath(bosh.dirs['images'].join('checkbox_red_x.png')),
        wx.BITMAP_TYPE_PNG)
    images['checkbox.red.x.24'] = Image(
        GPath(bosh.dirs['images'].join('checkbox_red_x_24.png')),
        wx.BITMAP_TYPE_PNG)
    images['checkbox.red.x.32'] = Image(
        GPath(bosh.dirs['images'].join('checkbox_red_x_32.png')),
        wx.BITMAP_TYPE_PNG)
    images['checkbox.red.off.16'] = (
    Image(GPath(bosh.dirs['images'].join('checkbox_red_off.png')),
        wx.BITMAP_TYPE_PNG))
    images['checkbox.red.off.24'] = (
    Image(GPath(bosh.dirs['images'].join('checkbox_red_off_24.png')),
        wx.BITMAP_TYPE_PNG))
    images['checkbox.red.off.32'] = (
    Image(GPath(bosh.dirs['images'].join('checkbox_red_off_32.png')),
        wx.BITMAP_TYPE_PNG))

    images['checkbox.green.on.16'] = (
    Image(GPath(bosh.dirs['images'].join('checkbox_green_on.png')),
        wx.BITMAP_TYPE_PNG))
    images['checkbox.green.off.16'] = (
    Image(GPath(bosh.dirs['images'].join('checkbox_green_off.png')),
        wx.BITMAP_TYPE_PNG))
    images['checkbox.green.on.24'] = (
    Image(GPath(bosh.dirs['images'].join('checkbox_green_on_24.png')),
        wx.BITMAP_TYPE_PNG))
    images['checkbox.green.off.24'] = (
    Image(GPath(bosh.dirs['images'].join('checkbox_green_off_24.png')),
        wx.BITMAP_TYPE_PNG))
    images['checkbox.green.on.32'] = (
    Image(GPath(bosh.dirs['images'].join('checkbox_green_on_32.png')),
        wx.BITMAP_TYPE_PNG))
    images['checkbox.green.off.32'] = (
    Image(GPath(bosh.dirs['images'].join('checkbox_green_off_32.png')),
        wx.BITMAP_TYPE_PNG))
    # --Bash
    images['bash.16'] = Image(GPath(bosh.dirs['images'].join('bash_16.png')),
        wx.BITMAP_TYPE_PNG)
    images['bash.24'] = Image(GPath(bosh.dirs['images'].join('bash_24.png')),
        wx.BITMAP_TYPE_PNG)
    images['bash.32'] = Image(GPath(bosh.dirs['images'].join('bash_32.png')),
        wx.BITMAP_TYPE_PNG)
    images['bash.16.blue'] = Image(
        GPath(bosh.dirs['images'].join('bash_16_blue.png')), wx.BITMAP_TYPE_PNG)
    images['bash.24.blue'] = Image(
        GPath(bosh.dirs['images'].join('bash_24_blue.png')), wx.BITMAP_TYPE_PNG)
    images['bash.32.blue'] = Image(
        GPath(bosh.dirs['images'].join('bash_32_blue.png')), wx.BITMAP_TYPE_PNG)
    # --Bash Patch Dialogue
    images['monkey.16'] = Image(
        GPath(bosh.dirs['images'].join('wryemonkey16.jpg')),
        wx.BITMAP_TYPE_JPEG)
    #  images['monkey.32'] = Image(GPath(bosh.dirs['images'].join('wryemonkey32.jpg')),wx.BITMAP_TYPE_JPEG)
    # --DocBrowser
    images['doc.16'] = Image(
        GPath(bosh.dirs['images'].join('DocBrowser16.png')), wx.BITMAP_TYPE_PNG)
    images['doc.24'] = Image(
        GPath(bosh.dirs['images'].join('DocBrowser24.png')), wx.BITMAP_TYPE_PNG)
    images['doc.32'] = Image(
        GPath(bosh.dirs['images'].join('DocBrowser32.png')), wx.BITMAP_TYPE_PNG)
    # --Applications Icons
    global bashRed
...
def InitStatusBar():
    ...
    BashStatusBar.buttons.append(  # Fallout NV
        FalloutNV_Button(
            ...
            Image(GPath(bosh.dirs['images'].join(
                'falloutnv' + bosh.inisettings['IconSize'] + '.png'))),
            _("Launch FalloutNV"),
    ...
    BashStatusBar.buttons.append(  # GECK
        App_Button(
            ...
            Image(GPath(bosh.dirs['images'].join(
                'geck' + bosh.inisettings['IconSize'] + '.png'))),
            _("Launch GECK"),
            _("Launch GECK + NVSE"),
            '-editor'))
    ...
    BashStatusBar.buttons.append(  # OBMLG
        App_Button(
            bosh.tooldirs['OBMLG'],
            Image(GPath(bosh.dirs['images'].join(
                'modlistgenerator' + bosh.inisettings['IconSize'] + '.png'))),
    ...
    BashStatusBar.buttons.append(  # BSACommander
        App_Button(
            ...
            Image(GPath(bosh.dirs['images'].join(
                'bsacommander' + bosh.inisettings['IconSize'] + '.png'))),
            _("Launch BSA Commander")))
    BashStatusBar.buttons.append(  # Tabula
        App_Button(
            bosh.tooldirs['Tabula'],
            Image(GPath(bosh.dirs['images'].join(
                'tabula' + bosh.inisettings['IconSize'] + '.png'))),
            _("Launch Tabula")))
    ...
    BashStatusBar.buttons.append(  # BOSS --
        App_BOSS(
            ...
            Image(GPath(bosh.dirs['images'].join(
                'Boss' + bosh.inisettings['IconSize'] + '.png'))),
            _("Launch BOSS")))
    if bosh.inisettings['ShowModelingToolLaunchers']:
        ...
        BashStatusBar.buttons.append(  # SpeedTree
            App_Button(
                ...
                Image(GPath(bosh.dirs['images'].join(
                    'speedtree' + bosh.inisettings['IconSize'] + '.png'))),
                _("Launch SpeedTree")))
        BashStatusBar.buttons.append(  # Tree[d]
            App_Button(
                bosh.tooldirs['Treed'],
                Image(GPath(bosh.dirs['images'].join(
                    'treed' + bosh.inisettings['IconSize'] + '.png'))),
                _("Launch Tree\[d\]")))
        BashStatusBar.buttons.append(  # Wings3D
            App_Button(
                bosh.tooldirs['Wings3D'],
                Image(GPath(bosh.dirs['images'].join(
                    'wings3d' + bosh.inisettings['IconSize'] + '.png'))),
                _("Launch Wings 3D")))
    if bosh.inisettings['ShowModelingToolLaunchers'] or bosh.inisettings[
        'ShowTextureToolLaunchers']:
        BashStatusBar.buttons.append(  # Nifskope
            App_Button(
                bosh.tooldirs['NifskopePath'],
                Image(GPath(bosh.dirs['images'].join(
                    'nifskope' + bosh.inisettings['IconSize'] + '.png'))),
                _("Launch Nifskope")))
    ...
    if bosh.inisettings['ShowAudioToolLaunchers']:
        ...
        BashStatusBar.buttons.append(  # Switch
            App_Button(
                ...
                Image(GPath(bosh.dirs['images'].join(
                    'switch' + bosh.inisettings['IconSize'] + '.png'))),
                _("Launch Switch")))
    BashStatusBar.buttons.append(  # Fraps
        App_Button(
            bosh.tooldirs['Fraps'],
            Image(GPath(bosh.dirs['images'].join(
                'fraps' + bosh.inisettings['IconSize'] + '.png'))),
            _("Launch Fraps")))
    BashStatusBar.buttons.append(  # MAP
        App_Button(
            bosh.tooldirs['MAP'],
            Image(GPath(bosh.dirs['images'].join(
                'interactivemapofcyrodiil' + bosh.inisettings[
                    'IconSize'] + '.png'))),
            ...
            if icon == '':
                if path.cext == '.exe':
                    ...
                    try:
                        ...
                        deprint('Error finding icon for %s:' % path.s,
                            traceback=True)
                        icon = 'not\\a\\path'
            icon = GPath(icon)
            # First try a custom icon
            customIcon = bosh.dirs['mopy'].join('Apps',
                path.body + bosh.inisettings['IconSize'] + '.png')
            if customIcon.exists():
                icon = Image(customIcon)
            # Next try the shortcut specified icon
            else:
                if icon.exists():
                    icon = Image(icon.s + ';' + idex, wx.BITMAP_TYPE_ICO,
                        int(bosh.inisettings['IconSize']))
                    # Last, use the 'x' icon
                else:
    ...
    BashStatusBar.buttons.append(
        App_Button(
            ...
            Image(GPath(bosh.dirs['images'].join(
                'Bashmon' + bosh.inisettings['IconSize'] + '.png'))),
            _("Launch BashMon")))
...
def InitInstallerLinks():
    ...
    InstallersPanel.mainMenu.append(
        List_Columns('bash.installers.cols', ['Package']))
    # --Actions
    InstallersPanel.mainMenu.append(SeparatorLink())
