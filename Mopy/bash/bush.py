...
topTypes = ['GMST', 'TXST', 'MICN', 'GLOB', 'CLAS', 'FACT', 'HDPT', 'HAIR',
    ...
    'TACT',
    'TERM', 'ARMO', 'BOOK', 'CONT', 'DOOR', 'INGR', 'LIGH', 'MISC', 'STAT',
    'SCOL',
    'MSTT', 'PWAT', 'GRAS', 'TREE', 'FURN', 'WEAP', 'AMMO', 'NPC_', 'CREA',
    'LVLC',
    'LVLN', 'KEYM', 'ALCH', 'IDLM', 'NOTE', 'COBJ', 'PROJ', 'LVLI', 'WTHR',
    'CLMT',
    'REGN', 'NAVI', 'DIAL', 'QUST', 'IDLE', 'PACK', 'CSTY', 'LSCR', 'ANIO',
    'WATR',
    'EFSH', 'EXPL', 'DEBR', 'IMGS', 'IMAD', 'FLST', 'PERK', 'BPTD', 'ADDN',
    'AVIF',
    'RADS', 'CAMS', 'CPTH', 'VTYP', 'IPCT', 'IPDS', 'ARMA', 'ECZN', 'MESG',
    'RGDL',
    'DOBJ', 'LGTM', 'MUSC', 'IMOD', 'REPU', 'RCPE', 'RCCT', 'CHIP', 'CSNO',
    'LSCT',
    'MSET', 'ALOC', 'CHAL', 'AMEF', 'CCRD', 'CMNY', 'CDCK', 'DEHY', 'HUNG',
    'SLPD',
    'CELL', 'WRLD', ]
...
conditionFunctionData = ( #--0: no param; 1: int param; 2: formid param
    ...
    (462, 'IsPlayerTagSkill', 2, 0, 0, 0),
    (464, 'IsPlayerGrabbedRef', 2, 0, 0, 0),
    (471, 'GetDestructionStage', 0, 0, 0, 0),
    (474, 'GetIsAlignment', 2, 0, 0, 0),
    (478, 'GetThreatRatio', 2, 0, 0, 0),
    (480, 'GetIsUsedItemEquipType', 2, 0, 0, 0),
    ...
    (573, 'GetReputation', 1, 1, 0, 0),
    (574, 'GetReputationPct', 1, 1, 0, 0),
    (575, 'GetReputationThreshold', 1, 1, 0, 0),
    (586, 'IsHardcore', 0, 0, 0, 0),
    (601, 'GetForceHitReaction', 0, 0, 0, 0),
    (607, 'ChallengeLocked', 2, 0, 0, 0),
    (610, 'GetCasinoWinningStage', 1, 0, 0, 0),
    ...
    (1076, 'GetWeaponHasScope', 2, 0, 0, 0),
    (1089, 'ListGetFormIndex', 2, 2, 0, 0),
    (1107, 'IsKeyPressed', 1, 1, 0, 0),
    (1131, 'IsControlPressed', 1, 1, 0, 0),
    (1271, 'HasOwnership', 2, 0, 0, 0),
    (1272, 'IsOwned', 2, 0, 0, 0),
    (1274, 'GetDialogueTarget', 2, 0, 0, 0),
    (1275, 'GetDialogueSubject', 2, 0, 0, 0),
    (1276, 'GetDialogueSpeaker', 2, 0, 0, 0),
    (1278, 'GetAgeClass', 2, 0, 0, 0),
    (1286, 'GetTokenValue', 2, 0, 0, 0),
    (1288, 'GetTokenRef', 2, 0, 0, 0),
    (1291, 'GetPaired', 2, 2, 0, 0),
    (1292, 'GetRespawn', 2, 0, 0, 0),
    (1294, 'GetPermanent', 2, 0, 0, 0),
    (1297, 'IsRefInList', 2, 2, 0, 0),
    (1301, 'GetPackageCount', 2, 0, 0, 0),
    (1440, 'IsPlayerSwimming', 0, 0, 0, 0),
    (1441, 'GetTFC', 0, 0, 0, 0),
    (1475, 'GetPerkRank', 2, 2, 0, 0),
    (1476, 'GetAltPerkRank', 2, 2, 0, 0),
    (1541, 'GetActorFIKstatus', 0, 0, 0, 0),

    # Added by nvse_plugin_ExtendedActorVariable
    (4352, 'GetExtendedActorVariable', 2, 0, 0, 0),
    (4353, 'GetBaseExtendedActorVariable', 2, 0, 0, 0),
    (4355, 'GetModExtendedActorVariable', 2, 0, 0, 0),

    # Added by nvse_extender
    (4420, 'NX_GetEVFl', 0, 0, 0, 0),
    (4426, 'NX_GetQVEVFl', 2, 1, 0, 0),

    # Added by lutana_nvse
    (4612, 'IsButtonPressed', 1, 0, 0, 0),
    ...
    (4708, 'GetArmorClass', 2, 0, 0, 0),
    (4709, 'IsRaceInList', 2, 0, 0, 0),
    (4758, 'IsButtonDisabled', 1, 0, 0, 0),
    (4761, 'IsButtonHeld', 1, 0, 0, 0),
    (4774, 'IsTriggerDisabled', 1, 0, 0, 0),
    (4777, 'IsTriggerHeld', 1, 0, 0, 0),
    (4822, 'GetReferenceFlag', 1, 0, 0, 0),
    ...
    (5947, 'GetActorLightAmount', 0, 0, 0, 0),
    (5951, 'GetGameDifficulty', 0, 0, 0, 0),
    ...
    (6065, 'AuxVarGetFltCond', 2, 1, 0, 0),
    (6069, 'IsInAir', 0, 0, 0, 0),
    (6070, 'GetHasContact', 2, 0, 0, 0),
    (6072, 'GetHasContactBase', 2, 0, 0, 0),
    (6073, 'GetHasContactType', 1, 0, 0, 0),
    (6124, 'IsSpellTargetAlt', 2, 0, 0, 0),
    (6167, 'IsIdlePlayingEx', 2, 0, 0, 0),
    (6186, 'IsInCharGen', 0, 0, 0, 0),
