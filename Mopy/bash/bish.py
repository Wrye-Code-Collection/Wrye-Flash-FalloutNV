...
def perfTest():
    ...
    for testClasses in ['bosh.MreAchr,bosh.MreCell,bosh.MreWrld',
        'bosh.MreAcre,bosh.MreCell,bosh.MreWrld', 'bosh.MreActi',
        'bosh.MreAlch', 'bosh.MreAmmo', 'bosh.MreAnio', 'bosh.MreAppa',
        'bosh.MreArmo', 'bosh.MreBook', 'bosh.MreBsgn',
        'bosh.MreCell,bosh.MreWrld', 'bosh.MreClas', 'bosh.MreClot',
        'bosh.MreCont', 'bosh.MreCrea', 'bosh.MreDial,bosh.MreInfo',
        'bosh.MreDoor', 'bosh.MreEfsh', 'bosh.MreEnch', 'bosh.MreEyes',
        'bosh.MreFact', 'bosh.MreFlor', 'bosh.MreFurn', 'bosh.MreGlob',
        'bosh.MreGmst', 'bosh.MreGras', 'bosh.MreHair', 'bosh.MreIngr',
        'bosh.MreKeym', 'bosh.MreLigh', 'bosh.MreLscr', 'bosh.MreLvlc',
        'bosh.MreLvli', 'bosh.MreMgef', 'bosh.MreMisc', 'bosh.MreNpc',
        'bosh.MrePack', 'bosh.MreQust', 'bosh.MreRace',
        'bosh.MreRefr,bosh.MreCell,bosh.MreWrld',
        'bosh.MreRoad,bosh.MreCell,bosh.MreWrld', 'bosh.MreScpt',
        'bosh.MreSgst', 'bosh.MreSkil', 'bosh.MreSlgm', 'bosh.MreSoun',
        'bosh.MreSpel', 'bosh.MreStat', 'bosh.MreTes4', 'bosh.MreTree',
...
def csFunctions(fileName="CS Functions.txt"):
    ...
    # --Page writer
    def groupLink(group):
        group = re.sub('NVSE', '[[:Category:FalloutNV_Script_Extender|NVSE]]',
            group)
...
def gmstIds(fileName=None):
    ...
    for eid in ['fPlayerDeathReloadTime', 'iMapMarkerVisibleDistance',
        ...
        'fJumpHeightMin', 'fPlayerPipBoyLightTimer',
        'iAINumberActorsComplexScene', 'iHackingMaxWords', 'fGunShellLifetime',
    ...
    if maxId > maxOld:
        ...
        print "%d news gmst ids written to FalloutNV_ids.pkl" % (
        (maxId - maxOld),)
...
@mainfunc
def renameArchives(
    root=r'C:\Program Files\Bethesda Softworks\Fallout New Vegas\Downloads'):
